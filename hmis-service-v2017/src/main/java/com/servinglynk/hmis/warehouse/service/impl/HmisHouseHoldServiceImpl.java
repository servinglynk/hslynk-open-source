...
public class HmisHouseHoldServiceImpl extends ServiceBase implements HmisHouseHoldService {
	...
	public HmisHousehold createHouseHold(HmisHousehold model,Account caller) {
		...
		com.servinglynk.hmis.warehouse.model.v2017.HmisHousehold entity = new com.servinglynk.hmis.warehouse.model.v2017.HmisHousehold();
	...
	@Transactional
	public com.servinglynk.hmis.warehouse.model.v2017.HmisHousehold createHmisHousehold(Client client,HmisHousehold model,Account caller){
		com.servinglynk.hmis.warehouse.model.v2017.HmisHousehold entity = new com.servinglynk.hmis.warehouse.model.v2017.HmisHousehold();
		entity.setHeadOfHousehold(client);
		entity.setDedupClientId(client.getDedupClientId());
		if(model.getSourceSystemHouseHoldId()!=null) entity.setSourceSystemHouseHoldId(model.getSourceSystemHouseHoldId());
	...
	public void updateHouseHold(HmisHousehold model,Account caller) {
		com.servinglynk.hmis.warehouse.model.v2017.HmisHousehold entity = daoFactory.getHmisHouseholdDao().getHouseHoldById(model.getHouseHoldId());
	...
	public void deleteHouseHold(UUID householeId) {
		com.servinglynk.hmis.warehouse.model.v2017.HmisHousehold entity = daoFactory.getHmisHouseholdDao().getHouseHoldById(householeId);
	...
	public HmisHouseholds getAllHouseHolds(Integer startIndex, Integer maxItems) {
		...
		List<com.servinglynk.hmis.warehouse.model.v2017.HmisHousehold> entities = daoFactory.getHmisHouseholdDao().getAllHouseHolds(startIndex, maxItems);
		for(com.servinglynk.hmis.warehouse.model.v2017.HmisHousehold entity : entities) {
	...
	public void addHouseHoldMember(HouseHoldMember member, Account caller) {
		com.servinglynk.hmis.warehouse.model.v2017.HmisHousehold entity = daoFactory.getHmisHouseholdDao().getHouseHoldById(member.getHouseHoldId());
	...
	public void removeHouseHoldMember(UUID householdId, UUID memberid, Account caller) {
		com.servinglynk.hmis.warehouse.model.v2017.HmisHousehold entity = daoFactory.getHmisHouseholdDao().getHouseHoldById(householdId);
