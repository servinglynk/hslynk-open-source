...
public class EducationServiceImpl extends ServiceBase implements EducationService  {
   ...
   public Education createEducation(Education education,UUID enrollmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2016.Education pEducation = EducationConverter.modelToEntity(education, null);
   ...
   public Education updateEducation(Education education,UUID enrollmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2016.Enrollment pEnrollment = daoFactory.getEnrollmentDao().getEnrollmentById(enrollmentId);
       if(pEnrollment == null) throw new EnrollmentNotFound();
       com.servinglynk.hmis.warehouse.model.v2016.Education pEducation = daoFactory.getEducationDao().getEducationById(education.getEducationId());
   ...
   public Education deleteEducation(UUID educationId,String caller){
       com.servinglynk.hmis.warehouse.model.v2016.Education pEducation = daoFactory.getEducationDao().getEducationById(educationId);
       if(pEducation==null) throw new EducationNotFoundException();
   ...
   public Educations getAllEnrollmentEducations(UUID enrollmentId,Integer startIndex, Integer maxItems){
       Educations educations = new Educations();
        List<com.servinglynk.hmis.warehouse.model.v2016.Education> entities = daoFactory.getEducationDao().getAllEnrollmentEducations(enrollmentId,startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.v2016.Education entity : entities){
