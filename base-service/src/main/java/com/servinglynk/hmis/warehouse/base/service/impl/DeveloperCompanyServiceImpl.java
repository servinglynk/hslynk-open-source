...
import com.servinglynk.hmis.warehouse.base.service.converter.ApiGroupConverter;
import com.servinglynk.hmis.warehouse.base.service.converter.ApiMethodConverter;
import com.servinglynk.hmis.warehouse.base.service.converter.DeveloperCompanyConverter;
import com.servinglynk.hmis.warehouse.base.service.converter.DeveloperServiceConverter;
...
public class DeveloperCompanyServiceImpl extends ServiceBase implements DeveloperCompanyService {
	...
	public DeveloperCompany createDeveloperCompany(DeveloperCompany developerCompany, String requestingService) {
		...
		com.servinglynk.hmis.warehouse.model.base.HmisUser account = daoFactory.getAccountDao()
				.findByUsername(developerCompany.getOwner().getUsername());

		if (account == null) throw new AccountNotFoundException();
		

		com.servinglynk.hmis.warehouse.model.base.DeveloperCompanyEntity pDeveloperCompany = DeveloperCompanyConverter
		...
		com.servinglynk.hmis.warehouse.model.base.DeveloperCompanyStatus pDeveloperCompanyStatus = new com.servinglynk.hmis.warehouse.model.base.DeveloperCompanyStatus();
	...
	public void updateDeveloperCompany(String externalDeveloperCompanyId, DeveloperCompany developerCompany,
		...
		com.servinglynk.hmis.warehouse.model.base.DeveloperCompanyEntity pDeveloperCompany = daoFactory
	...
	public DeveloperService updateService(String externalServiceId, DeveloperService service, Account requestingAccount,
		...
		com.servinglynk.hmis.warehouse.model.base.DeveloperServiceEntity pService = daoFactory.getDeveloperServiceDao()
		...
		if (!ValidationUtil.isEmpty(service.getFriendlyName())) {
			if (!pService.getFriendlyName().equalsIgnoreCase(service.getFriendlyName())) {
				com.servinglynk.hmis.warehouse.model.base.DeveloperServiceEntity dbService = daoFactory
	...
	public ServiceStatus processApprovalSubmission(String externalServiceId, ServiceStatus serviceStatus,
		...
		com.servinglynk.hmis.warehouse.model.base.ServiceStatus pServiceStatus = new com.servinglynk.hmis.warehouse.model.base.ServiceStatus();
	...
	public void createApiBundleForService(String externalServiceId, ApiMethods apiBundle, Account requestingAccount,
		...
		com.servinglynk.hmis.warehouse.model.base.DeveloperCompanyEntity pDeveloperCompany = pService.getDeveloperCompany();
...
/*		if (!Constants.SERVICE_STATUS_IN_DEVELOPMENT.equals(pService.getStatus())) {
	...
	public DeveloperCompanies getAllDeveloperCompanies(String username, String serviceStatus, String trustedAppStatus,
		...
		List<com.servinglynk.hmis.warehouse.model.base.DeveloperCompanyEntity> pDeveloperCompanies = daoFactory
		...
		if (pDeveloperCompanies != null) {
			for (com.servinglynk.hmis.warehouse.model.base.DeveloperCompanyEntity pDeveloperCompany : pDeveloperCompanies) {
