...
("hbase.columns.mapping" = ":key,CF:status_message,CF:status,CF:housing_unit_id,CF:client_id,CF:project_id,CF:project_group_code,CF:process_id,CF:created_at,CF:updated_at,CF:user_id") TBLPROPERTIES ("hbase.table.name" = "match_process_log_MC0005");
...
CF:user_id,CF:user_create,CF:user_update,CF:date_created,CF:date_updated,CF:deleted") TBLPROPERTIES ("hbase.table.name" = "global_household_MC0005");
...
CF:user_id,			
CF:deleted,			
CF:ignore_match_process") TBLPROPERTIES ("hbase.table.name" = "eligible_clients_MC0005");
...
CF:project_group_code,
CF:project_id,
CF:deleted") TBLPROPERTIES ("hbase.table.name" = "housing_unit_MC0005");
...
CF:inactive,
CF:project_group_code,
CF:deleted") TBLPROPERTIES ("hbase.table.name" = "housing_unit_eligibility_MC0005");
...
ignore_match_process boolean)
STORED BY 'org.apache.hadoop.hive.hbase.HBaseStorageHandler' WITH SERDEPROPERTIES 
("hbase.columns.mapping" = ":key,CF:dedup_client_id,CF:first_name,CF:last_name,CF:survey_id,CF:survey_title,CF:survey_date,CF:survey_score,CF:phone,CF:email,CF:age,CF:notes,CF:ignore_match_process") TBLPROPERTIES ("hbase.table.name" = "active_list_MC0005");
...
TBLPROPERTIES ("hbase.table.name" = "match_reservations_MC0005");
...
CF:client_dedup_id
")
TBLPROPERTIES ("hbase.table.name" = "match_status_MC0005");
...
CF:next_status_code")
TBLPROPERTIES ("hbase.table.name" = "match_status_levels_MC0005");
...
CF:deleted,
CF:status_code")
TBLPROPERTIES ("hbase.table.name" = "match_status_remarks_MC0005");
...
TBLPROPERTIES ("hbase.table.name" = "status_note_MC0005");


CREATE EXTERNAL TABLE IF NOT EXISTS hmis_notification
(
id BIGINT,
message_type string,
status string,
...
CF:username,
CF:project_group_id")
TBLPROPERTIES ("hbase.table.name" = "hmis_user_MC0005");
