...
public class SyncPostgresProcessor extends Logging{
    ...
    public static List<BulkUpload> getExportIDFromBulkUpload(int schemaYear) {
        ResultSet resultSet = null;
        PreparedStatement statement = null;
        Connection connection = null;
    ...
    public static void updateCreateFlag(String groupCode, VERSION version) {
        PreparedStatement statement = null;
        Connection connection = null;
        try {
            connection = getConnection();
    ...
    public static void updateSyncFlag(String tableName, UUID id, String schema) {
        PreparedStatement statement = null;
        Connection connection = null;
        try {
            connection = getConnection();
    ...
    public static void updateBulkUploadStatusToLive(Long id) {
        PreparedStatement statement = null;
        Connection connection = null;
        try {
            connection = getConnection();
