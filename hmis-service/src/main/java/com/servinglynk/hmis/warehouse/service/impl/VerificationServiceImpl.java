...
public class VerificationServiceImpl extends ServiceBase implements
	...
	public Account getAccountByVerfication(Verification verification) {
		...
		com.servinglynk.hmis.warehouse.model.v2014.HmisUser pAccount = daoFactory.getAccountDao().findByVerificationId(pVerification.getId());
	...
	public Verification updateVerificationStatus(Verification verification,
		...
		if (pVerification.isStatusAccepted()) {
			if (pVerification.getType().equalsIgnoreCase(VERIFICATION_TYPE_ACCOUNT_CREATION)) {
				...
				com.servinglynk.hmis.warehouse.model.v2014.HmisUser pAccount = pPasswordReset.getAccount();
				...
				//get account	
				com.servinglynk.hmis.warehouse.model.v2014.HmisUser account = accountDataChange.getAccount();
				//change username
