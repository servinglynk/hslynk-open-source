...
public class TrustedAppConverter {
	...
	public static com.servinglynk.hmis.warehouse.entity.TrustedAppEntity convertToPersistentTrustedApp(TrustedApp trustedApp,TrustedAppEntity trustedAppEntity) {
		
		if (trustedAppEntity == null) {
			trustedAppEntity = new com.servinglynk.hmis.warehouse.entity.TrustedAppEntity();
		}
