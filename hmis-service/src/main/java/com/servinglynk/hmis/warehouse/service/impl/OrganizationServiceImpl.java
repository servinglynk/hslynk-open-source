...
public class OrganizationServiceImpl extends ServiceBase implements OrganizationService  {
   ...
   public Organization updateOrganization(Organization organization,String caller){
       com.servinglynk.hmis.warehouse.model.live.Organization pOrganization = daoFactory.getOrganizationDao().getOrganizationById(organization.getOrganizationId());
   ...
   public Organization deleteOrganization(UUID organizationId,String caller){
       com.servinglynk.hmis.warehouse.model.live.Organization pOrganization = daoFactory.getOrganizationDao().getOrganizationById(organizationId);
       if(pOrganization==null) throw new OrganizationNotFoundException();
   ...
   public Organizations getAllOrganizations(Integer startIndex, Integer maxItems){
       Organizations organizations = new Organizations();
        List<com.servinglynk.hmis.warehouse.model.live.Organization> entities = daoFactory.getOrganizationDao().getAllOrganizations(startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.live.Organization entity : entities){
