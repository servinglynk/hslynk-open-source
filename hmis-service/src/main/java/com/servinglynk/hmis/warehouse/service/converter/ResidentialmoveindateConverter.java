...
public class ResidentialmoveindateConverter {
   ...
   public static com.servinglynk.hmis.warehouse.model.live.Residentialmoveindate modelToEntity (Residentialmoveindate model ,com.servinglynk.hmis.warehouse.model.live.Residentialmoveindate entity) {
       if(entity==null) entity = new com.servinglynk.hmis.warehouse.model.live.Residentialmoveindate();
   ...
   public static Residentialmoveindate entityToModel (com.servinglynk.hmis.warehouse.model.live.Residentialmoveindate entity) {
