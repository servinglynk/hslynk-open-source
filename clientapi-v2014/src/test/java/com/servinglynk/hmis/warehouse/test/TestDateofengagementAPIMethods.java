...
public class TestDateofengagementAPIMethods {
    ...
    public void TestDateofengagementAPIMethods_2_update_Dateofengagement_testcase() throws Exception {
       ...
       dateofengagement= executor.executePut("/clients/"+clientId+"/enrollments/"+enrollmentId+"/dateofengagements/"+dateofengagement.getDateofengagementId(),dateofengagement,Dateofengagement.class);
   }
    ...
    public void TestDateofengagementAPIMethods_3_delete_Dateofengagement_testcase() throws Exception {
       ...
       dateofengagement= executor.executeDelete("/clients/"+clientId+"/enrollments/"+enrollmentId+"/dateofengagements/"+dateofengagement.getDateofengagementId(),dateofengagement,Dateofengagement.class);
       Assert.assertNull(dateofengagement.getDateofengagementId()); 
   }
