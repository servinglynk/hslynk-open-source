...
app.controller('bulkUploadCtrl', function ($scope, $location, $routeSegment, $http, $timeout,$sessionStorage){
	...
	// Define the string
   var encodeAaccessKeyId = 'QUtJQUo1NzVXVzNVQU9GU0FZVFE=';
   var encodedSecretKey = 'SFdabFdBMnVMd2N6NDlYeUx0TGFiajI1bkJrMzBIVDE0Yi96YlhHMg==';
	// Decode the String
	var decodedAaccessKeyId = Base64.decode(encodeAaccessKeyId);
	var decodedSecretKey = Base64.decode(encodedSecretKey);
   ...
   $scope.showSuccessAlert = false;
     $scope.showErrorAlert = false;
        ...
        AWS.config.update({
        accessKeyId : decodedAaccessKeyId,
