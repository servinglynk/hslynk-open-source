...
public class IncomeAndSourceServiceImpl extends ServiceBase implements IncomeAndSourceService  {
   ...
   public IncomeAndSource createIncomeAndSource(IncomeAndSource incomeAndSource,UUID enrollmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2016.Incomeandsources pIncomeAndSource = IncomeAndSourceConverter.modelToEntity(incomeAndSource, null);
   ...
   public IncomeAndSource updateIncomeAndSource(IncomeAndSource incomeAndSource,UUID enrollmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2016.Enrollment pEnrollment = daoFactory.getEnrollmentDao().getEnrollmentById(enrollmentId);
       if(pEnrollment == null) throw new EnrollmentNotFound();
       com.servinglynk.hmis.warehouse.model.v2016.Incomeandsources pIncomeAndSource = daoFactory.getIncomeandsourcesDao().getIncomeAndSourceById(incomeAndSource.getIncomeAndSourceId());
       ...
       pIncomeAndSource.setUserId(daoFactory.getHmisUserDao().findByUsername(caller).getId());
   ...
   public IncomeAndSource deleteIncomeAndSource(UUID incomeAndSourceId,String caller){
       com.servinglynk.hmis.warehouse.model.v2016.Incomeandsources pIncomeAndSource = daoFactory.getIncomeandsourcesDao().getIncomeAndSourceById(incomeAndSourceId);
       if(pIncomeAndSource==null) throw new IncomeAndSourceNotFoundException();
   ...
   public IncomeAndSources getAllEnrollmentIncomeAndSources(UUID enrollmentId,Integer startIndex, Integer maxItems){
       IncomeAndSources incomeAndSources = new IncomeAndSources();
        List<com.servinglynk.hmis.warehouse.model.v2016.Incomeandsources> entities = daoFactory.getIncomeandsourcesDao().getAllEnrollmentIncomeAndSources(enrollmentId,startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.v2016.Incomeandsources entity : entities){
