...
@Entity
@Table(name = "hmis_service",schema="base")
public class ServiceEntity extends BaseModel {
	...
	@OneToMany(mappedBy = "service")
	private List<ServiceApiMethodEntity> serviceApiMethods;
	...
	public List<ServiceApiMethodEntity> getServiceApiMethods() {
		return serviceApiMethods;
	}
	public void setServiceApiMethods(List<ServiceApiMethodEntity> serviceApiMethods) {
		this.serviceApiMethods = serviceApiMethods;
	}
