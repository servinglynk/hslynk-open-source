...
public class BasicDataGenerator {
	 ...
	 *            The length of the string to be generated.
	 * @param unique
	 *            Overloaded method to generate unique Strings. If true returns
	 *            a unique value.
	...
	/**
	 * Generate a random integer within the specified range and returns it as a
	 * Long object.
	 * 
	 * @param upperLimit
	...
	/**
	 * Generate a unique random integer within the specified range and returns
	 * it as a Long object.
	 * 
	 * @param upperLimit
	 *            Upper bound of range
	...
	/**
	 * Generate a unique random Long. RETURNS UP TO INTEGER.MAX_VALUE instead to
	 * deal with the unsigned integer case in the DB!!
	 *
	 * @param unique
	 *            Overloaded method to generate unique Strings. If true returns
	 *            a unique value.
	 ...
	 *            Overloaded method to generate unique Strings. If true returns
	 *            a unique value.
	 * @return A unique random Integer with respect to the specified upper
	 *         bound.
	 */
	...
	/**
	 * Generate a random Integer and casted to a Long. Upper bound 16777215
	 *
	...
	/**
	 * Generate a unique random Integer and casted to a Long. Upper bound
	 * 16777215
	 * 
	 * @param unique
	 *            Overloaded method to generate unique Strings. If true returns
	 ...
	 * 
	 * @param integral
	 *            The number of integers present in the decimal number.
	 *            (Example: integral being 10 would result in a decimal like
	 *            103667.5576 or 11.32547569)
	 * @param fraction
	 *            The number of integers present in the decimal, after the
	 *            decimal point. (Example: fraction being 2 would result in a
	 *            decimal like 3.55 or 77844.39)
	 ...
	 * 
	 * @param currentEnum
	 *            An enum from which to select an element
	...
	/**
	 * Given a path to the class where the enums are, a single random enum is
	 * returned.
	 * 
	 * @param <T>
	 *            The class to be used, which extends the enum to be returned.
	 * @param className
	 *            The full path of the Class with enums
	 * @return A random enum from the class
	 */
	@SuppressWarnings("unchecked")
	public static <T extends Enum<?>> T generateRandomEnumFromClass(
			String className) {
	 ...
	 *            The class to be used, which extends the enum to be returned.
	 * @param c
	 *            The class containing the enums
	 * @return A random enum from the class
	 */
