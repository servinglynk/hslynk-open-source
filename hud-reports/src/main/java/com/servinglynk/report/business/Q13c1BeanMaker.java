...
public class Q13c1BeanMaker extends BaseBeanMaker{
	...
	String mentalHealthQuery = "   select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and  datacollectionstage in ('1','2','5')  and information_date >= :startDate and information_date <=:endDate and disabilitytype='9' ";
	...
	String alcoholQuery = "  select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and  datacollectionstage in ('1','2','5')  and information_date >= :startDate and information_date <=:endDate and disabilitytype='10' and disabilityresponse='1' ";
	...
	String drugQuery = "  select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and  datacollectionstage in ('1','2','5')  and information_date >= :startDate and information_date <=:endDate and disabilitytype='10' and disabilityresponse='2'";
	...
	String alcoholAndDrugQuery = "  select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and   datacollectionstage in ('1','2','5') and information_date >= :startDate and information_date <=:endDate and disabilitytype='10' and disabilityresponse='3' ";
	...
	String chronicHealthCondition = " select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and   datacollectionstage in ('1','2','5')  and information_date >= :startDate and information_date <=:endDate and disabilitytype='7' ";
	...
	String hivaids = "select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and   datacollectionstage in ('1','2','5')  and information_date >= :startDate and information_date <=:endDate and disabilitytype='8' ";
	...
	String developmentDisability =   "select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and   datacollectionstage in ('1','2','5')  and information_date >= :startDate and information_date <=:endDate and disabilitytype='6' ";
	...
	String physicalDisabilitiy = "   select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and   datacollectionstage in ('1','2','5')  and information_date >= :startDate and information_date <=:endDate and disabilitytype='5' ";
