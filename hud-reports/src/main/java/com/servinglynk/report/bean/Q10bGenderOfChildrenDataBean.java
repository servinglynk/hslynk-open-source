...
public class Q10bGenderOfChildrenDataBean {

	private BigInteger totChildMale=BigInteger.valueOf(0);
	private BigInteger totChildFemale=BigInteger.valueOf(0);
	private BigInteger totChildTransgenderMF=BigInteger.valueOf(0);
	private BigInteger totChildOther=BigInteger.valueOf(0);
	private BigInteger totChildDontKnowRefused=BigInteger.valueOf(0);
	private BigInteger totChildInfoMissing=BigInteger.valueOf(0);
	private BigInteger totChildSubtotal=BigInteger.valueOf(0);
	private BigInteger childMaleWOC=BigInteger.valueOf(0);
	private BigInteger childMaleWCA=BigInteger.valueOf(0);
	private BigInteger childMaleUHHT=BigInteger.valueOf(0);
	private BigInteger childFemaleWOC=BigInteger.valueOf(0);
	private BigInteger childFemaleWCA=BigInteger.valueOf(0);
	private BigInteger childFemaleUHHT=BigInteger.valueOf(0);
	private BigInteger childTransgenderMFWOC=BigInteger.valueOf(0);
	private BigInteger childTransgenderMFWCA=BigInteger.valueOf(0);
	private BigInteger childTransgenderMFUHHT=BigInteger.valueOf(0);
	private BigInteger childOtherWOC=BigInteger.valueOf(0);
	private BigInteger childOtherWCA=BigInteger.valueOf(0);
	private BigInteger childOtherUHHT=BigInteger.valueOf(0);
	private BigInteger childDkrWOC=BigInteger.valueOf(0);
	private BigInteger childDkrWCA=BigInteger.valueOf(0);
	private BigInteger childDkrUHHT=BigInteger.valueOf(0);
	private BigInteger childInfomiisingWOC=BigInteger.valueOf(0);
	private BigInteger childInfomiisingWCA=BigInteger.valueOf(0);
	private BigInteger childInfomiisingUHHT=BigInteger.valueOf(0);
	private BigInteger childSubtotalWOC=BigInteger.valueOf(0);
	private BigInteger childSubtotalWCA=BigInteger.valueOf(0);
	private BigInteger childSubtotalUHHT=BigInteger.valueOf(0);
	private BigInteger totChildTransgenderFM=BigInteger.valueOf(0);
	private BigInteger childTransgenderFMWOC=BigInteger.valueOf(0);
	private BigInteger childTransgenderFMWCA=BigInteger.valueOf(0);
	private BigInteger childTransgenderFMUHHT=BigInteger.valueOf(0);
