...
public class Q04aCSVController {

	private Logger logger = Logger.getLogger(Q04aCSVController.class);
	
    @SuppressWarnings("unchecked")
	public static void q04aExportoCSV(List<Q04aDataBean> dataBeanList) {
		try {                                           
			ClassLoader classLoader = Q04aCSVController.class.getClassLoader();
			File file = new File(classLoader.getResource("q04a.jrxml").getFile());
		    ...
		    OutputStream ouputStream  = new FileOutputStream(new File("Q04a.csv"));
