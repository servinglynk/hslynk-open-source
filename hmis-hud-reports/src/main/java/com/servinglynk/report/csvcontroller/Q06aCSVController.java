...
public class Q06aCSVController {

	private static Logger logger = Logger.getLogger(Q06aCSVController.class);
	
    @SuppressWarnings("unchecked")
	public static void buildReport(List<Q06aReportValidationsTableDataBean> dataBeanList) {
		try {                                           
			ClassLoader classLoader = Q04aCSVController.class.getClassLoader();
			File file = new File(classLoader.getResource("q06a.jrxml").getFile());
		    ...
		    OutputStream ouputStream  = new FileOutputStream(new File("Q06a.csv"));
