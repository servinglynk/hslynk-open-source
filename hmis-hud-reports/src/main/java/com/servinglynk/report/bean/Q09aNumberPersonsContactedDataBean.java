...
public class Q09aNumberPersonsContactedDataBean {
	
	private BigInteger totContactedOnce=BigInteger.valueOf(0);
	private BigInteger coFirstContactNotStaying=BigInteger.valueOf(0);
	private BigInteger coFirstContactStaying=BigInteger.valueOf(0);
	private BigInteger coFirstContactWorkerUnableToDetermine=BigInteger.valueOf(0);
	private BigInteger totContacted2to5Times=BigInteger.valueOf(0);
	private BigInteger c2to5FirstContactedNotStaying=BigInteger.valueOf(0);
	private BigInteger c2to5FirstContactStaying=BigInteger.valueOf(0);
	private BigInteger c2to5FirstContactedWorkerUnableToDetermine=BigInteger.valueOf(0);
	private BigInteger totContacted6to9Times=BigInteger.valueOf(0);
	private BigInteger c6to9FirstContactedNotStaying=BigInteger.valueOf(0);
	private BigInteger c6to9FirstContactedWorkerUnableToDetermine=BigInteger.valueOf(0);
	private BigInteger totContacted10orMore=BigInteger.valueOf(0);
	private BigInteger c6to9FirstContactStaying=BigInteger.valueOf(0);
	private BigInteger c10orMoreFirstContactedNotStaying=BigInteger.valueOf(0);
	private BigInteger c10orMoreFirstContactStaying=BigInteger.valueOf(0);
	private BigInteger c10orMoreFirstContactedWorkerUnableToDetermine=BigInteger.valueOf(0);
	private BigInteger totPersonsContacted=BigInteger.valueOf(0);
	private BigInteger tpcFirstContactedNotStaying=BigInteger.valueOf(0);
	private BigInteger tpcFirstContactStaying=BigInteger.valueOf(0);
	private BigInteger tpcFirstContactedWorkerUnableToDetermine=BigInteger.valueOf(0);
	/**
