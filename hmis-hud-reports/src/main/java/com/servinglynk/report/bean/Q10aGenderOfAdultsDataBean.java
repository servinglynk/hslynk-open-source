...
public class Q10aGenderOfAdultsDataBean {

	private BigInteger totMale=BigInteger.valueOf(0);
	private BigInteger totFemale=BigInteger.valueOf(0);
	private BigInteger totTransgenderMF=BigInteger.valueOf(0);
	private BigInteger totOther=BigInteger.valueOf(0);
	private BigInteger totDontKnowRefused=BigInteger.valueOf(0);
	private BigInteger totInfoMissing=BigInteger.valueOf(0);
	private BigInteger totSubtotal=BigInteger.valueOf(0);
	private BigInteger maleWOC=BigInteger.valueOf(0);
	private BigInteger maleWCA=BigInteger.valueOf(0);
	private BigInteger maleUHHT=BigInteger.valueOf(0);
	private BigInteger femaleWOC=BigInteger.valueOf(0);
	private BigInteger femaleWCA=BigInteger.valueOf(0);
	private BigInteger femaleUHHT=BigInteger.valueOf(0);
	private BigInteger transgenderMFWOC=BigInteger.valueOf(0);
	private BigInteger transgenderMFWCA=BigInteger.valueOf(0);
	private BigInteger transgenderMFUHHT=BigInteger.valueOf(0);
	private BigInteger otherWOC=BigInteger.valueOf(0);
	private BigInteger otherWCA=BigInteger.valueOf(0);
	private BigInteger otherUHHT=BigInteger.valueOf(0);
	private BigInteger dkrWOC=BigInteger.valueOf(0);
	private BigInteger dkrWCA=BigInteger.valueOf(0);
	private BigInteger dkrUHHT=BigInteger.valueOf(0);
	private BigInteger infomiisingWOC=BigInteger.valueOf(0);
	private BigInteger infomiisingWCA=BigInteger.valueOf(0);
	private BigInteger infomiisingUHHT=BigInteger.valueOf(0);
	private BigInteger subtotalWOC=BigInteger.valueOf(0);
	private BigInteger subtotalWCA=BigInteger.valueOf(0);
	private BigInteger subtotalUHHT=BigInteger.valueOf(0);
	private BigInteger totTransgenderFM=BigInteger.valueOf(0);
	private BigInteger transgenderFMWOC=BigInteger.valueOf(0);
	private BigInteger transgenderFMWCA=BigInteger.valueOf(0);
	private BigInteger transgenderFMUHHT=BigInteger.valueOf(0);
