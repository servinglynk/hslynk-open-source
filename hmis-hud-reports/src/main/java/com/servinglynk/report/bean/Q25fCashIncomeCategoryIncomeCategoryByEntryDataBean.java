...
public class Q25fCashIncomeCategoryIncomeCategoryByEntryDataBean {
	...
	private BigInteger q25f1OrMoreSourceOfIncomeAtEntry;
	private BigInteger q25f1OrMoreSourceOfIncomeStayers;
	private BigInteger q25f1OrMoreSourceOfIncomeLeavers;
		
	private BigInteger q25fAdultsWithIncomeInfoAtEntry;
	private BigInteger q25fAdultsWithIncomeInfoStayers;
	private BigInteger q25fAdultsWithIncomeInfoLeavers;
	...
	public BigInteger getQ25f1OrMoreSourceOfIncomeAtEntry() {
		return q25f1OrMoreSourceOfIncomeAtEntry;
	}
	public void setQ25f1OrMoreSourceOfIncomeAtEntry(
			BigInteger q25f1OrMoreSourceOfIncomeAtEntry) {
		this.q25f1OrMoreSourceOfIncomeAtEntry = q25f1OrMoreSourceOfIncomeAtEntry;
	}
	public BigInteger getQ25f1OrMoreSourceOfIncomeStayers() {
		return q25f1OrMoreSourceOfIncomeStayers;
	}
	public void setQ25f1OrMoreSourceOfIncomeStayers(
			BigInteger q25f1OrMoreSourceOfIncomeStayers) {
		this.q25f1OrMoreSourceOfIncomeStayers = q25f1OrMoreSourceOfIncomeStayers;
	}
	public BigInteger getQ25f1OrMoreSourceOfIncomeLeavers() {
		return q25f1OrMoreSourceOfIncomeLeavers;
	}
	public void setQ25f1OrMoreSourceOfIncomeLeavers(
			BigInteger q25f1OrMoreSourceOfIncomeLeavers) {
		this.q25f1OrMoreSourceOfIncomeLeavers = q25f1OrMoreSourceOfIncomeLeavers;
	}
	public BigInteger getQ25fAdultsWithIncomeInfoAtEntry() {
		return q25fAdultsWithIncomeInfoAtEntry;
	}
	public void setQ25fAdultsWithIncomeInfoAtEntry(
			BigInteger q25fAdultsWithIncomeInfoAtEntry) {
		this.q25fAdultsWithIncomeInfoAtEntry = q25fAdultsWithIncomeInfoAtEntry;
	}
	public BigInteger getQ25fAdultsWithIncomeInfoStayers() {
		return q25fAdultsWithIncomeInfoStayers;
	}
	public void setQ25fAdultsWithIncomeInfoStayers(
			BigInteger q25fAdultsWithIncomeInfoStayers) {
		this.q25fAdultsWithIncomeInfoStayers = q25fAdultsWithIncomeInfoStayers;
	}
	public BigInteger getQ25fAdultsWithIncomeInfoLeavers() {
		return q25fAdultsWithIncomeInfoLeavers;
	}
	public void setQ25fAdultsWithIncomeInfoLeavers(
			BigInteger q25fAdultsWithIncomeInfoLeavers) {
		this.q25fAdultsWithIncomeInfoLeavers = q25fAdultsWithIncomeInfoLeavers;
	}
