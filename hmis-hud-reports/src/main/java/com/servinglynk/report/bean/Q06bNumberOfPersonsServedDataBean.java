...
public class Q06bNumberOfPersonsServedDataBean {
	...
	private BigInteger npDkrWcaTot;
	...
	public BigInteger getNpDkrWcaTot() {
		return npDkrWcaTot;
	}
	public void setNpDkrWcaTot(BigInteger npDkrWcaTot) {
		this.npDkrWcaTot = npDkrWcaTot;
	}
