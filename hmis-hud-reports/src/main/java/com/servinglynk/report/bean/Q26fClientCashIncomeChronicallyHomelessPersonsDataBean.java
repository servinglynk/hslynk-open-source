...
public class Q26fClientCashIncomeChronicallyHomelessPersonsDataBean {
	...
	public BigInteger getQ26f1OrMoreSourceOfIncomeAtEntry() {
		return q26f1OrMoreSourceOfIncomeAtEntry;
	}
	public void setQ26f1OrMoreSourceOfIncomeAtEntry(
			BigInteger q26f1OrMoreSourceOfIncomeAtEntry) {
		this.q26f1OrMoreSourceOfIncomeAtEntry = q26f1OrMoreSourceOfIncomeAtEntry;
	}
	public BigInteger getQ26f1OrMoreSourceOfIncomeStayers() {
		return q26f1OrMoreSourceOfIncomeStayers;
	}
	public void setQ26f1OrMoreSourceOfIncomeStayers(
			BigInteger q26f1OrMoreSourceOfIncomeStayers) {
		this.q26f1OrMoreSourceOfIncomeStayers = q26f1OrMoreSourceOfIncomeStayers;
	}
	public BigInteger getQ26f1OrMoreSourceOfIncomeLeavers() {
		return q26f1OrMoreSourceOfIncomeLeavers;
	}
	public void setQ26f1OrMoreSourceOfIncomeLeavers(
			BigInteger q26f1OrMoreSourceOfIncomeLeavers) {
		this.q26f1OrMoreSourceOfIncomeLeavers = q26f1OrMoreSourceOfIncomeLeavers;
	}
	public BigInteger getQ26fAdultsWithIncomeInfoAtEntryAtEntry() {
		return q26fAdultsWithIncomeInfoAtEntryAtEntry;
	}
	public void setQ26fAdultsWithIncomeInfoAtEntryAtEntry(
			BigInteger q26fAdultsWithIncomeInfoAtEntryAtEntry) {
		this.q26fAdultsWithIncomeInfoAtEntryAtEntry = q26fAdultsWithIncomeInfoAtEntryAtEntry;
	}
	public BigInteger getQ26fAdultsWithIncomeInfoAtEntryStayers() {
		return q26fAdultsWithIncomeInfoAtEntryStayers;
	}
	public void setQ26fAdultsWithIncomeInfoAtEntryStayers(
			BigInteger q26fAdultsWithIncomeInfoAtEntryStayers) {
		this.q26fAdultsWithIncomeInfoAtEntryStayers = q26fAdultsWithIncomeInfoAtEntryStayers;
	}
	public BigInteger getQ26fAdultsWithIncomeInfoAtEntryLeavers() {
		return q26fAdultsWithIncomeInfoAtEntryLeavers;
	}
	public void setQ26fAdultsWithIncomeInfoAtEntryLeavers(
			BigInteger q26fAdultsWithIncomeInfoAtEntryLeavers) {
		this.q26fAdultsWithIncomeInfoAtEntryLeavers = q26fAdultsWithIncomeInfoAtEntryLeavers;
	}
