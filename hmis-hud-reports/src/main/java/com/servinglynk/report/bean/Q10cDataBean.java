...
public class Q10cDataBean {
	...
	private BigInteger totMAIMale=BigInteger.valueOf(0);
	private BigInteger totMAIFemale=BigInteger.valueOf(0);
	private BigInteger totMAITransgenderMF=BigInteger.valueOf(0);
	private BigInteger totMAIOther=BigInteger.valueOf(0);
	private BigInteger totMAIDontKnowRefused=BigInteger.valueOf(0);
	private BigInteger totMAIInfoMissing=BigInteger.valueOf(0);
	private BigInteger totMAISubtotal=BigInteger.valueOf(0);
	private BigInteger maleMAIWOC=BigInteger.valueOf(0);
	private BigInteger maleMAIWCA=BigInteger.valueOf(0);
	private BigInteger maleMAIUHHT=BigInteger.valueOf(0);
	private BigInteger femaleMAIWOC=BigInteger.valueOf(0);
	private BigInteger femaleMAIWCA=BigInteger.valueOf(0);
	private BigInteger femaleMAIUHHT=BigInteger.valueOf(0);
	private BigInteger transgenderMFMAIWOC=BigInteger.valueOf(0);
	private BigInteger transgenderMFMAIWCA=BigInteger.valueOf(0);
	private BigInteger transgenderMFMAIUHHT=BigInteger.valueOf(0);
	private BigInteger otherMAIWOC=BigInteger.valueOf(0);
	private BigInteger otherMAIWCA=BigInteger.valueOf(0);
	private BigInteger otherMAIUHHT=BigInteger.valueOf(0);
	private BigInteger dkrMAIWOC=BigInteger.valueOf(0);
	private BigInteger dkrMAIWCA=BigInteger.valueOf(0);
	private BigInteger dkrMAIUHHT=BigInteger.valueOf(0);
	private BigInteger infomissingMAIWOC=BigInteger.valueOf(0);
	private BigInteger infomissingMAIWCA=BigInteger.valueOf(0);
	private BigInteger infomissingMAIUHHT=BigInteger.valueOf(0);
	private BigInteger subtotalMAIWOC=BigInteger.valueOf(0);
	private BigInteger subtotalMAIWCA=BigInteger.valueOf(0);
	private BigInteger subtotalMAIUHHT=BigInteger.valueOf(0);
	private BigInteger totMAITransgenderFM=BigInteger.valueOf(0);
	private BigInteger transgenderFMMAIWOC=BigInteger.valueOf(0);
	private BigInteger transgenderFMMAIWCA=BigInteger.valueOf(0);
	private BigInteger transgenderFMMAIUHHT=BigInteger.valueOf(0);
	private BigInteger transgenderFMMAIWithOnlyChild=BigInteger.valueOf(0);
	private BigInteger subtotalMAIWithOnlyChild=BigInteger.valueOf(0);
	private BigInteger infomissingMAIWithOnlyChild=BigInteger.valueOf(0);
	private BigInteger dkrMAIWithOnlyChild=BigInteger.valueOf(0);
	private BigInteger transgenderMFMAIWithOnlyChild=BigInteger.valueOf(0);
	private BigInteger otherMAIWithOnlyChild=BigInteger.valueOf(0);
	private BigInteger maleMAIWithOnlyChild=BigInteger.valueOf(0);
	private BigInteger femaleMAIWithOnlyChild=BigInteger.valueOf(0);
