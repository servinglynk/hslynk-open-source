...
public class Q23bExitDestination90DaysOrLessDataBeanMaker {
	
	public static List<Q23bExitDestination90DaysOrLessDataBean> getQ23bExitDestination90DaysOrLessList(){
		Q23bExitDestination90DaysOrLessDataBean q23bExitDestination90DaysOrLessTable = new Q23bExitDestination90DaysOrLessDataBean();
	
			q23bExitDestination90DaysOrLessTable.setQ23BAPermanentDestinationsTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BAPermanentDestinationsWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BAPermanentDestinationsWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BAPermanentDestinationsWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BAPermanentDestinationsUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BA01MovedFromOneHOPWATotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA01MovedFromOneHOPWAWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA01MovedFromOneHOPWAWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA01MovedFromOneHOPWAWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA01MovedFromOneHOPWAUnknownHouseHold(BigInteger.valueOf(0));


			q23bExitDestination90DaysOrLessTable.setQ23BA02OwnedByClientNoOngoingSubsidyTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA02OwnedByClientNoOngoingSubsidyWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA02OwnedByClientNoOngoingSubsidyWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA02OwnedByClientNoOngoingSubsidyWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA02OwnedByClientNoOngoingSubsidyUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BA03OwnedByClientWithOngoingSubsidyTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA03OwnedByClientWithOngoingSubsidyWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA03OwnedByClientWithOngoingSubsidyWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA03OwnedByClientWithOngoingSubsidyWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA03OwnedByClientWithOngoingSubsidyUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BA04RentalByClientNoOngoingSubsidyTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA04RentalByClientNoOngoingSubsidyWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA04RentalByClientNoOngoingSubsidyWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA04RentalByClientNoOngoingSubsidyWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA04RentalByClientNoOngoingSubsidyUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BA05RentalByClientVASHSubsidyTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA05RentalByClientVASHSubsidyWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA05RentalByClientVASHSubsidyWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA05RentalByClientVASHSubsidyWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA05RentalByClientVASHSubsidyUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BA06RentalByClientwithGPDTIPHousingTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA06RentalByClientwithGPDTIPHousingWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA06RentalByClientwithGPDTIPHousingWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA06RentalByClientwithGPDTIPHousingWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA06RentalByClientwithGPDTIPHousingUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BA07RentalByClientOtherOngoingSubsidyTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA07RentalByClientOtherOngoingSubsidyWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA07RentalByClientOtherOngoingSubsidyWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA07RentalByClientOtherOngoingSubsidyWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA07RentalByClientOtherOngoingSubsidyUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BA08PermanentHousingForHomelessTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA08PermanentHousingForHomelessWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA08PermanentHousingForHomelessWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA08PermanentHousingForHomelessWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA08PermanentHousingForHomelessUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BA09StayingOrLivingWithFamilyPermanentTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA09StayingOrLivingWithFamilyPermanentWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA09StayingOrLivingWithFamilyPermanentWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA09StayingOrLivingWithFamilyPermanentWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA09StayingOrLivingWithFamilyPermanentUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BA10StayingOrLivingWithFriendsPermanentTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA10StayingOrLivingWithFriendsPermanentWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA10StayingOrLivingWithFriendsPermanentWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA10StayingOrLivingWithFriendsPermanentWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BA10StayingOrLivingWithFriendsPermanentUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BAzTotTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BAzTotWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BAzTotWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BAzTotWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BAzTotUnknownHouseHold(BigInteger.valueOf(0));
			...
			q23bExitDestination90DaysOrLessTable.setQ23BB1EmergencyShelterTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB1EmergencyShelterWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB1EmergencyShelterWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB1EmergencyShelterWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB1EmergencyShelterUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BB2MovedFromOneHOPWATotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB2MovedFromOneHOPWAWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB2MovedFromOneHOPWAWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB2MovedFromOneHOPWAWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB2MovedFromOneHOPWAUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BB3TransitionalHousingForHomeLessTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB3TransitionalHousingForHomeLessWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB3TransitionalHousingForHomeLessWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB3TransitionalHousingForHomeLessWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB3TransitionalHousingForHomeLessUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BB4StayingWithFamilyTemporaryTenureTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB4StayingWithFamilyTemporaryTenureWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB4StayingWithFamilyTemporaryTenureWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB4StayingWithFamilyTemporaryTenureWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB4StayingWithFamilyTemporaryTenureUnknownHouseHold(BigInteger.valueOf(0));

			q23bExitDestination90DaysOrLessTable.setQ23BB5StayingWithFriendsTemporaryTenureTotal(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB5StayingWithFriendsTemporaryTenureWithoutChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB5StayingWithFriendsTemporaryTenureWithChildAndAdults(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB5StayingWithFriendsTemporaryTenureWithOnlyChild(BigInteger.valueOf(0));
			q23bExitDestination90DaysOrLessTable.setQ23BB5StayingWithFriendsTemporaryTenureUnknownHouseHold(BigInteger.valueOf(0));
