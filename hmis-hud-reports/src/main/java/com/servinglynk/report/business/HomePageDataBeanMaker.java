...
public class HomePageDataBeanMaker {
			...
			if(sageReport) {
				CSVGenerator.buildReport(q04aDataBeanList, "q04a.jrxml", "Q4a.csv");
			}
			...
			if(q06dDataBeanList!=null){
				CSVGenerator.buildReport(q06dDataBeanList, "q06d.jrxml", "Q6d.csv");
			}
			...
			if(q06eDataBeanList!=null){
				CSVGenerator.buildReport(q06eDataBeanList, "q06e.jrxml", "Q6e.csv");
			}
			...
			if(q06fDataBeanList!=null){
				CSVGenerator.buildReport(q06fDataBeanList, "q06f.jrxml", "Q6f.csv");
			}
			...
			if(q08aDataBeanList!=null){
				CSVGenerator.buildReport(q08aDataBeanList, "q08a.jrxml", "Q8a.csv");
			}
			...
			if(q08bDataBeanList!=null){
				CSVGenerator.buildReport(q08bDataBeanList, "q08b.jrxml", "Q8b.csv");
			}
			...
			List<Q23aExitDestinationMoreThan90DaysDataBean> q23aBeanList = Q23ExitDestinationMoreThan90DaysDataBeanMaker.getQ23ExitDestinationMoreThan90DaysList();
			homePageDataBean.setQ23ExitDestinationMoreThan90DaysDataBean(q23aBeanList);
			if(q23aBeanList!=null){
				CSVGenerator.buildReport(q23aBeanList, "q23a.jrxml","Q23a.csv");
			}
			
			List<Q23bExitDestination90DaysOrLessDataBean> q23bBean = Q23bExitDestination90DaysOrLessDataBeanMaker.getQ23bExitDestination90DaysOrLessList();
			homePageDataBean.setQ23bExitDestination90DaysOrLessDataBean(q23bBean);
			if(q23bBean!=null){
				CSVGenerator.buildReport(q23bBean, "q23b.jrxml","Q23b.csv");
			}
