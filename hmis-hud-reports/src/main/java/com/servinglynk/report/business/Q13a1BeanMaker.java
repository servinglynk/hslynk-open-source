...
public class Q13a1BeanMaker extends BaseBeanMaker {
	...
	public static List<Q13a1PhysicalAndMentalHealthConditionsAtEntryDataBean> getQ13a1PhysicalAndMentalHealthConditionsAtEntryList(ReportData data){
		...
		String mentalHealthQuery = " select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and datacollectionstage = '1' and disabilitytype='9' and information_date >= :startDate and information_date <= :endDate ";
    	...
    	String alcoholQuery = " select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and datacollectionstage = '1' and disabilitytype='10' and disabilityresponse='1' and information_date >= :startDate and information_date <= :endDate  ";
    	...
    	String drugQuery = " select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and datacollectionstage = '1' and disabilitytype='10' and disabilityresponse='2'  and information_date >= :startDate and information_date <= :endDate ";
    	...
    	String alcoholAndDrugQuery = " select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and datacollectionstage = '1' and disabilitytype='10' and disabilityresponse='3' and information_date >= :startDate and information_date <= :endDate  ";
    	...
    	String chronicHealthCondition = " select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and  datacollectionstage = '1' and disabilitytype='7'  and information_date >= :startDate and information_date <= :endDate ";
    	...
    	String hivaids = " select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and  datacollectionstage = '1' and disabilitytype='8'  and information_date >= :startDate and information_date <= :endDate ";
    	...
    	String developmentDisability = " select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and  datacollectionstage = '1' and disabilitytype='6'  and information_date >= :startDate and information_date <= :endDate ";
    	...
    	String physicalDisabilitiy = "  select e.id from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and  datacollectionstage = '1' and disabilitytype='5' and information_date >= :startDate and information_date <= :endDate  ";
