...
public class Q13a1BeanMaker extends BaseBeanMaker {
	...
	public static List<Q13a1PhysicalAndMentalHealthConditionsAtEntryDataBean> getQ13a1PhysicalAndMentalHealthConditionsAtEntryList(ReportData data){
		...
		String query = " select distinct(e.dedup_client_id) from %s.disabilities d, %s.enrollment e where e.id =d.enrollmentid and TO_DATE(information_date)=TO_DATE(e.entrydate) and datacollectionstage = '1'    and information_date <= :endDate ";
