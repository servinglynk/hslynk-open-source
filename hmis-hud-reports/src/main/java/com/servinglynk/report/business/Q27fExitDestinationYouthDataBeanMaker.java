	...
	public static List<Q27fExitDestinationYouthDataBean> getQ27fExitDestinationYouthList(ReportData data){
		...
		try {
			if(data.isLiveMode()) {
				...
				//33
				q27fExitDestinationYouthTable.setQ27f13ClientByHVCVoucherTotal(BigInteger.valueOf(allTotal33));
				q27fExitDestinationYouthTable.setQ27f13ClientByHVCVoucherWithoutChild(BigInteger.valueOf(withoutChildren33));
				q27fExitDestinationYouthTable.setQ27f13ClientByHVCVoucherWithOnlyChild(BigInteger.valueOf(withChildren33));
				q27fExitDestinationYouthTable.setQ27f13ClientByHVCVoucherWithChildAndAdults(BigInteger.valueOf(withChildAndAdults33));
				q27fExitDestinationYouthTable.setQ27f13ClientByHVCVoucherUnknownHouseHold(BigInteger.valueOf(unknown33));
				//34
				q27fExitDestinationYouthTable.setQ27f13RentalByClientPublicHousingTotal(BigInteger.valueOf(allTotal34));
				q27fExitDestinationYouthTable.setQ27f13RentalByClientPublicHousingWithoutChild(BigInteger.valueOf(withoutChildren34));
				q27fExitDestinationYouthTable.setQ27f13RentalByClientPublicHousingWithOnlyChild(BigInteger.valueOf(withChildren34));
				q27fExitDestinationYouthTable.setQ27f13RentalByClientPublicHousingWithChildAndAdults(BigInteger.valueOf(withChildAndAdults34));
				q27fExitDestinationYouthTable.setQ27f13RentalByClientPublicHousingUnknownHouseHold(BigInteger.valueOf(unknown33));
...
//				q27fExitDestinationYouthTable.setQ27fBTemporaryDestinationsUnknownHouseHoldtype(BigInteger.valueOf(0));
				...
				//32
				q27fExitDestinationYouthTable.setQ27fBHostHomeTotal(BigInteger.valueOf(allTotal32));
				q27fExitDestinationYouthTable.setQ27fB8HostHomeWithoutChild(BigInteger.valueOf(withoutChildren32));
				q27fExitDestinationYouthTable.setQ27fB8HostHomeWithChildAndAdults(BigInteger.valueOf(withChildAndAdult32));
				q27fExitDestinationYouthTable.setQ27fB8HostHomeWithOnlyChild(BigInteger.valueOf(withChildren32));
				q27fExitDestinationYouthTable.setQ27fB8HostHomeUnknownHouseHold(BigInteger.valueOf(unknown32));
				//24
...
//				
				...
				//34
				q27fExitDestinationYouthTable.setQ27fD1ResidentialProjectorHalfwayHouseWithTotal(BigInteger.valueOf(allTotal34a));
				q27fExitDestinationYouthTable.setQ27fD1ResidentialProjectorHalfwayHouseWithWithoutChild(BigInteger.valueOf(withoutChildren34a));
				q27fExitDestinationYouthTable.setQ27fD1ResidentialProjectorHalfwayHouseWithWithChildAndAdults(BigInteger.valueOf(withChildAndAdult34a));
				q27fExitDestinationYouthTable.setQ27fD1ResidentialProjectorHalfwayHouseWithWithChildOnly(BigInteger.valueOf(withChildren34a));
				q27fExitDestinationYouthTable.setQ27fD1ResidentialProjectorHalfwayHouseWithUnknownHouseHoldtype(BigInteger.valueOf(unknown34a));
				//35
