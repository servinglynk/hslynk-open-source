...
public class Q19a2DataBeanMaker extends BaseBeanMaker {
	...
	public static void 	hydrateEarnedIncome(Q19DataBean q19dataBean,Q19a2ClientCashIncomeChangeIncomeSourceByEntryDataBean q19a2Bean) {
		//#B
			...
			q19a2Bean.setQ19a2NoOfAdltsWithEarnedIncomeHadIncomeCategoryAtEntryAndDidNotHaveAtExit(q19dataBean.getNoOfAdltsWithEarnedIncomeDidNotHaveTheIncomeCategoryAtEntryOrFollowup());
		//
	...
	public static void 	hydrateOverallIncome(Q19DataBean q19dataBean,Q19a2ClientCashIncomeChangeIncomeSourceByEntryDataBean q19a2Bean) {
		//#B
			...
			q19a2Bean.setQ19a2NumberOfAdultsWithAnyIncomeDidNotHaveTheIncomeCategoryAtEntryAndGainedIncomeCategoryExit(q19dataBean.getNumberOfAdultsWithAnyIncomeDidNotHaveTheIncomeCategoryAtEntryOrFollowup());
		//C
		...
		//#G
			q19a2Bean.setQ19a2NumberOfAdultsWithAnyIncomeDidNotHaveTheIncomeCategoryAtEntryAndGainedIncomeCategoryExit(q19dataBean.getNumberOfAdultsWithAnyIncomeDidNotHaveTheIncomeCategoryAtEntryOrFollowup());
			q19a2Bean.setQ19a2AverageChangeInOverallIncomeDidNotHaveTheIncomeCategoryAtEntryAndGainedIncomeCategoryExit(BigInteger.ZERO);
