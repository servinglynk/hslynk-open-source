...
public class Q11BeanMaker {
	...
	public static List<Q11AgeDataBean> getQ11AgeList(ReportData data){
	    		...
	    		q11AgeDataBean.setAge13to17UHHT(BigInteger.valueOf(0));
	    		q11AgeDataBean.setAge13to17WCA(BigInteger.valueOf(0));
	    		q11AgeDataBean.setAge13to17WithOnlyChild(BigInteger.valueOf(0));
	    		q11AgeDataBean.setAge13to17WOC(BigInteger.valueOf(0));
	    		q11AgeDataBean.setAge18to24UHHT(BigInteger.valueOf(0));
	    		q11AgeDataBean.setAge18to24WCA(BigInteger.valueOf(0));
	    		q11AgeDataBean.setAge18to24WithOnlyChild(BigInteger.valueOf(0));
	    		q11AgeDataBean.setAge18to24WOC(BigInteger.valueOf(0));
	    		...
	    		q11AgeDataBean.setAgeUnder5UHHT(BigInteger.valueOf(0));
	    		q11AgeDataBean.setAgeUnder5WCA(BigInteger.valueOf(0));
	    		q11AgeDataBean.setAgeUnder5WithOnlyChild(BigInteger.valueOf(0));
	    		q11AgeDataBean.setAgeUnder5WOC(BigInteger.valueOf(0));
	    		...
	    		q11AgeDataBean.setTotAge13to17(BigInteger.valueOf(0));
	    		q11AgeDataBean.setTotAge18to24(BigInteger.valueOf(0));
	    		...
	    		q11AgeDataBean.setTotAge5to12(BigInteger.valueOf(0));
	    		...
	    		q11AgeDataBean.setTotAgeUnder5(BigInteger.valueOf(0));
	    		q11AgeDataBean.setTotOverallTotal(BigInteger.valueOf(0));
	    		q11AgeDataBean.setAge5to12UHHT(BigInteger.valueOf(0));
