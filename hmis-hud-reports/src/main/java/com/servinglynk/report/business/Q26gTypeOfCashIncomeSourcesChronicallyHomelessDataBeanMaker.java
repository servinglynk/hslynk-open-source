...
public class Q26gTypeOfCashIncomeSourcesChronicallyHomelessDataBeanMaker {
	
	public static List<Q26gTypeOfCashIncomeSourcesChronicallyHomelessDataBean> getQ26gTypeOfCashIncomeSourcesChronicallyHomelessList(){
		
		Q26gTypeOfCashIncomeSourcesChronicallyHomelessDataBean q26gTypeOfCashIncomeSourcesChronicallyHomelessTable = new Q26gTypeOfCashIncomeSourcesChronicallyHomelessDataBean();
		...
		return Arrays.asList(q26gTypeOfCashIncomeSourcesChronicallyHomelessTable);
	}
