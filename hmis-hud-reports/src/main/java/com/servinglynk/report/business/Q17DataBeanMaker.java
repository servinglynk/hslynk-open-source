...
public class Q17DataBeanMaker extends BaseBeanMaker {
	...
	public static List<Q17DataBean> getQ17CashIncomeSourcesList(ReportData data){
		...
		int alimonyIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +" and alimony ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int alimonyIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +" and  alimony ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int alimonyIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +"  and alimony ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int childsupportIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +"  and childsupport ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int childsupportIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +"  and childsupport ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int childsupportIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +"  and childsupport ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int earnedIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +" and  earned ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int earnedIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +" and  earned ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int earnedIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +"  and earned ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int gaIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +"  and ga ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int gaIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +"  and ga ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int gaIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +"  and ga ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int othersourceIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +"  and othersource ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int othersourceIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +"  and othersource ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int othersourceIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +" and  othersource ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int pensionIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +" and  pension ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int pensionIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +"  and pension ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int pensionIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +"  and pension ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int privatedisabilityIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +" and  privatedisability ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int privatedisabilityIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +" and  privatedisability ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int privatedisabilityIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +"  and privatedisability ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int socsecretirementIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +"  and socsecretirement ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int socsecretirementIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +" and  socsecretirement ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int socsecretirementIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +"  and socsecretirement ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int ssdiIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +" and  ssdi ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int ssdiIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +" and  ssdi ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int ssdiIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +" and  ssdi ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int ssiIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +"  and ssi ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int ssiIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +"  and ssi ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int ssiIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +"  and ssi ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int tanfIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +" and  tanf ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int tanfIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +"  and  tanf ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int tanfIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +"  and tanf ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int unemploymentIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +" and  unemployment ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int unemploymentIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +"  and unemployment ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int unemploymentIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +"  and unemployment ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int vadisabilitynonserviceIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +" and  vadisabilitynonservice ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int vadisabilitynonserviceIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +" and  vadisabilitynonservice ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int vadisabilitynonserviceIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +" and  vadisabilitynonservice ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int vadisabilityserviceIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +"  and vadisabilityservice ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int vadisabilityserviceIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +" and  vadisabilityservice ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int vadisabilityserviceIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +" and  vadisabilityservice ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
		...
		int workerscompIncomeAtEntry = getIncomeCnt(data.getSchema(), entryQuery +" and  workerscomp ='1' ", "1",data.getReportStartDate(),data.getReportEndDate());
		int workerscompIncomeAtExit = getIncomeCnt(data.getSchema(), entryQuery +" and  workerscomp ='1' ", "3",data.getReportStartDate(),data.getReportEndDate());
		int workerscompIncomeAtAnnualAssesment = getIncomeCnt(data.getSchema(), entryQuery +" and  workerscomp ='1' ", "5",data.getReportStartDate(),data.getReportEndDate());
