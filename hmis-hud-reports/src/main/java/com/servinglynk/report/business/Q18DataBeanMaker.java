...
//		
		...
		List<IncomeSourceModel> incomeAtAnnualAssesment = getIncome(data.getSchema(), query, DataCollectionStage.ANNUAL_ASSESMENT.getCode());
		...
		List<IncomeSourceModel> noearnedIncomeAtEntry = getIncome(data.getSchema(), query+" earnedamount = 0 or  earnedamount is null " , DataCollectionStage.ENTRY.getCode());
		List<IncomeSourceModel> noearnedIncomeAtExit = getIncome(data.getSchema(), query+" earnedamount = 0 or  earnedamount is null ", DataCollectionStage.EXIT.getCode());
		List<IncomeSourceModel> noearnedIncomeAtAnnualAssesment = getIncome(data.getSchema(), query+"  earnedamount = 0 or  earnedamount is null  ", DataCollectionStage.ANNUAL_ASSESMENT.getCode());
