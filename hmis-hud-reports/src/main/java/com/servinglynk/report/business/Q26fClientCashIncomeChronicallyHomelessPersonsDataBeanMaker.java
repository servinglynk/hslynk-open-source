...
public class Q26fClientCashIncomeChronicallyHomelessPersonsDataBeanMaker {
	
	public static List<Q26fClientCashIncomeChronicallyHomelessPersonsDataBean> getQ26fClientCashIncomeChronicallyHomelessPersonsList(){
		
		Q26fClientCashIncomeChronicallyHomelessPersonsDataBean q26fClientCashIncomeChronicallyHomelessPersonsTable = new Q26fClientCashIncomeChronicallyHomelessPersonsDataBean();
		...
		q26fClientCashIncomeChronicallyHomelessPersonsTable.setQ26f1OrMoreSourceOfIncomeAtEntry(BigInteger.valueOf(0));
		q26fClientCashIncomeChronicallyHomelessPersonsTable.setQ26f1OrMoreSourceOfIncomeStayers(BigInteger.valueOf(0));
		q26fClientCashIncomeChronicallyHomelessPersonsTable.setQ26f1OrMoreSourceOfIncomeLeavers(BigInteger.valueOf(0));

		q26fClientCashIncomeChronicallyHomelessPersonsTable.setQ26fAdultsWithIncomeInfoAtEntryAtEntry(BigInteger.valueOf(0));
		q26fClientCashIncomeChronicallyHomelessPersonsTable.setQ26fAdultsWithIncomeInfoAtEntryStayers(BigInteger.valueOf(0));
		q26fClientCashIncomeChronicallyHomelessPersonsTable.setQ26fAdultsWithIncomeInfoAtEntryLeavers(BigInteger.valueOf(0));
	
		return Arrays.asList(q26fClientCashIncomeChronicallyHomelessPersonsTable);
	}
