...
public class DataBeanMaker {
        ...
        public static ArrayList<DataBean> getDataBeanList() {
                ...
                DataBean bean =(firstPage("1/1/2015",
                		" ",
                		"APR - Services Only",
                		"Everyone",
                		"all grants",
		 ...
		 * Q05A HMIS or Comparable Database Data Quality Table -- Starts
		 **/
		private static DataBean q05ACDDQ(
		 ...
		 * Q06A Report Validations Table -- Starts
		 **/
		private static DataBean q06AReportValidations(
		...
		private static DataBean q06BNumberOfPersonsServed(
         ...
         BigInteger npUHTTotal, DataBean q06BNumberOfPersonsServed){
		 ...
		 * Q06C Point-in-Time Count of Persons on the Last Wednesday Table -- Starts
		 **/
		private static DataBean q06CPCPLastWednesday(
		...
		private static DataBean q07AHouseHoldsServed(BigInteger overAllTot,
   	         ...
   	         BigInteger totHhWithChildAndAdults,
   	     	 ...
   	     	 BigInteger totHhUnknowHhType, DataBean q07AHouseHoldsServed){
		...
		private static DataBean q07BPointinTimeCountHHLastWednesday(BigInteger hhJanTotal,
	     ...
	     **/
		private static DataBean q09ANumberOfPersonsContacted(BigInteger totContactedOnce,
        ...
        /**
   	     * "Q10c: Gender of Persons Missing Age Information"  Table -- Starts
	   	 */  
        private static DataBean q10CGPMI( 
        ...
        /**
   	     * "Q11: Age"  Table -- Starts
   	    */
        private static DataBean q11AgeTableBean(BigInteger totAgeUnder5, BigInteger totAge5to12,
        ...
        public static DataBean q12bEthnicityTableBean(BigInteger q12bNonHispanicTotal,
        ...
        public static DataBean q13a2NumberofConditioinsTableBean(BigInteger q13a2NoneTotal,
        ...
        public static DataBean q13b2NumberOfConditionsAtExitTableBean(BigInteger q13b2NoneTotal,
    	...
    	public static DataBean q13c2NumberOfConditionForStayersTableBean(BigInteger q13c2NoneTotal,
    	...
    	public static DataBean q14aDomesticViolenceHistoryTableBean(BigInteger q14aYesTotal,
    	...
    	public static DataBean q14bPersonsFleeingDomesticViolenceTableBean(BigInteger q14bYesTotal,
