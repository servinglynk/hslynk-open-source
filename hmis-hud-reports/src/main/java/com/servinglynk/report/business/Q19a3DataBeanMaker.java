...
public class Q19a3DataBeanMaker extends BaseBeanMaker {
	...
	public static void 	hydrateEarnedIncome(Q19DataBean q19dataBean,Q19a3ClientCashIncomeChangeIncomeSourceByEntryDataBean q19a3Bean) {
		//#B
			...
			q19a3Bean.setQ19a3NoOfAdltsWithEarnedIncomeHadIncomeCategoryAtEntryAndDidNotHavefollowupOrExit(q19dataBean.getNoOfAdltsWithEarnedIncomeDidNotHaveTheIncomeCategoryAtEntryOrFollowup());
		//C
	   ...
	   public static void 	hydrateOtherIncome(Q19DataBean q19dataBean,Q19a3ClientCashIncomeChangeIncomeSourceByEntryDataBean q19a3Bean) {
		//#B
			...
			q19a3Bean.setQ19a3NoOfAdultsWithOtherIncomeHadIncomeCategoryAtEntryAndDidNotHavefollowupOrExit(q19dataBean.getNoOfAdultsWithOtherIncomeDidNotHaveTheIncomeCategoryAtEntryOrFollowup());
		//C
	...
	public static void 	hydrateOverallIncome(Q19DataBean q19dataBean,Q19a3ClientCashIncomeChangeIncomeSourceByEntryDataBean q19a3DataBean) {
		//#B
			...
			q19a3DataBean.setQ19a3NumberOfAdultsWithAnyIncomeHadIncomeCategoryAtEntryAndDidNotHavefollowupOrExit(q19dataBean.getNumberOfAdultsWithAnyIncomeDidNotHaveTheIncomeCategoryAtEntryOrFollowup());
		//C
