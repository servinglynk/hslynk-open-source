...
public class Q19a3DataBeanMaker extends BaseBeanMaker {
	...
	public static void populateEarnedIncome(Q19a3ClientCashIncomeChangeIncomeSourceByEntryDataBean q19a3Bean, List<IncomeAndSourceModel> incomes,BigInteger allClientsBigInt) {
		...
		if(CollectionUtils.isNotEmpty(earnedIncomeAtEntry)) {
			...
			q19a3Bean.setQ19a3AverageChangeInEarnedIncomeHadIncomeCategoryAtEntryAndDidNotHavefollowupOrExit(average);
			q19a3Bean.setQ19a3NoOfAdltsWithEarnedIncomeHadIncomeCategoryAtEntryAndDidNotHavefollowupOrExit(BigInteger.valueOf(earnedIncomeAtStartWithOutAA));
		}
		
		//#C
		q19a3Bean.setQ19a3NoOfAdltsWithEarnedIncomeRetainedIncomeCategoryButHadLessDollarAtFollowupOrExitAtEntry(BigInteger.valueOf(retainEarnedIncomeCatLessAtAAThanAtEntry));
		if(retainEarnedIncomeCatLessAtAAThanAtEntry !=0) {
			...
			q19a3Bean.setQ19a3AverageChangeInEarnedIncomeRetainedIncomeCategoryButHadLessDollarAtFollowupOrExitAtEntry(retainIncomeAtAAThenAtEntryAmount);
		}
		//#D
		q19a3Bean.setQ19a3NoOfAdltsWithEarnedIncomeRetainedIncomeCategoryAndSameDollartFollowupOrExitAtEntry(BigInteger.valueOf(retainEarnedIncomeCatSameAtAAThanAtEntry));
		if(retainEarnedIncomeCatSameAtAAThanAtEntry !=0) {
			...
			q19a3Bean.setQ19a3AverageChangeInEarnedIncomeRetainedIncomeCategoryAndSameDollartFollowupOrExitAtEntry(retainIncomeCatSameAtAAThanAtEntryAmount);
		}
		
		//#H
		q19a3Bean.setQ19a3NoOfAdltsWithEarnedIncomeTotalAdult(allClientsBigInt);
		q19a3Bean.setQ19a3AverageChangeInEarnedIncomeTotalAdult(earnedIncomePerformaceMeasure.multiply(BigInteger.valueOf(100)).divide(allClientsBigInt) );
		
	
		if(retainEarnedIncomeCatGreaterAtAAThanAtEntry !=0) {
				//#E
				q19a3Bean.setQ19a3NoOfAdltsWithEarnedIncomeRetainedIncomeCategoryAndIncreasedDollarAtFollowupOrExit(BigInteger.valueOf(retainEarnedIncomeCatGreaterAtAAThanAtEntry));
				...
				q19a3Bean.setQ19a3AverageChangeInEarnedIncomeRetainedIncomeCategoryAndIncreasedDollarAtFollowupOrExit(earnedIncomeCatGreaterAtAAThanAtEntryAmount);
			
				//#I
				BigInteger  earnedIncomePerformaceMeasureAverage =  earnedIncomePerformaceMeasure.divide(retainIncomeCatGreater);
				q19a3Bean.setQ19a3NoOfAdltsWithEarnedIncomePerformanceMeasures(retainIncomeCatGreater);
				q19a3Bean.setQ19a3AverageChangeInEarnedIncomePerformanceMeasures(earnedIncomePerformaceMeasureAverage);
			
				//#J
				q19a3Bean.setQ19a3NoOfAdltsWithEarnedIncomePercent(retainIncomeCatGreater.multiply(BigInteger.valueOf(100)).divide(allClientsBigInt));
		...
		if(noOfAdultsDidNotHaveTheIncomeCategoryAtEntryAndGainedTheIncome != 0 && sumadultsDidNotHaveTheIncomeCategoryAtEntryAndGainedTheIncome != BigInteger.ZERO) {
			...
			q19a3Bean.setQ19a3NoOfAdltsWithEarnedIncomeDidNotHaveIncomeCategoryEntryAndGainedIncomeCategoryAtFollowupOrExit(BigInteger.valueOf(noOfAdultsDidNotHaveTheIncomeCategoryAtEntryAndGainedTheIncome));
			q19a3Bean.setQ19a3AverageChangeInEarnedIncomeDidNotHaveIncomeCategoryEntryAndGainedIncomeCategoryAtFollowupOrExit(average);
		}
		//#G
		q19a3Bean.setQ19a3NoOfAdltsWithEarnedIncomeDidNotHaveIncomeCategoryAtEntryOrFollowupOrExit(BigInteger.valueOf(getSize(clientIds)));
...
public static void populateOverallIncomeIncome(Q19a3ClientCashIncomeChangeIncomeSourceByEntryDataBean q19a1Bean, List<IncomeAndSourceModel> incomes,BigInteger allClientsBigInt) {
		...
		if(retainOtherIncomeCatGreaterAtAAThanAtEntry !=0) {
				...
				q19a1Bean.setQ19a3NumberOfAdultsWithAnyIncomePerformanceMeasures(retainIncomeCatGreater);
				q19a1Bean.setQ19a3AverageChangeInOverallIncomePerformanceMeasures(otherIncomePerformaceMeasureAverage);
			
				//#J
				q19a1Bean.setQ19a3NumberOfAdultsWithAnyIncomePercent(retainIncomeCatGreater.multiply(BigInteger.valueOf(100)).divide(allClientsBigInt));
		...
		if(noOfAdultsDidNotHaveTheOtherIncomeCategoryAtEntryAndGainedTheIncome != 0 && sumadultsDidNotHaveOtherIncomeCategoryAtEntryAndGainedTheIncome != BigInteger.ZERO) {
			...
			q19a1Bean.setQ19a3AverageChangeInOverallIncomeDidNotHaveIncomeCategoryAtEntryOrFollowupOrExit(average);
		}
		//#G
...
public static void populateOtherIncome(Q19a3ClientCashIncomeChangeIncomeSourceByEntryDataBean q19a3Bean, List<IncomeAndSourceModel> incomes,BigInteger allClientsBigInt) {
	...
	List<IncomeAndSourceModel> otherIncomeATEntryButNotAtAA = incomes.parallelStream().filter(income -> ( StringUtils.equals("3",income.getDataCollectionStage())  || StringUtils.equals("5",income.getDataCollectionStage())  )  && (getFloat(income.getTotalmonthlyincome()) - getFloat(income.getEarnedamount()))  >0).collect(Collectors.toList());
	Map<String,BigInteger>  otherIncomeMapAtEntry = new HashMap<>();
	...
	//#B
	q19a3Bean.setQ19a3AverageChangeInOtherIncomeHadIncomeCategoryAtEntryAndDidNotHavefollowupOrExit(BigInteger.valueOf(otherIncomeAtStartWithOutAA));
	if(CollectionUtils.isNotEmpty(otherIncomeAtEntry) && otherIncomeAtStartWithOutAA !=0) {
		...
		average = average.multiply(BigInteger.valueOf(-1));
		q19a3Bean.setQ19a3AverageChangeInOtherIncomeHadIncomeCategoryAtEntryAndDidNotHavefollowupOrExit(average);
		q19a3Bean.setQ19a3NoOfAdultsWithOtherIncomeHadIncomeCategoryAtEntryAndDidNotHavefollowupOrExit(BigInteger.valueOf(otherIncomeAtStartWithOutAA));
	}
	//#C
	q19a3Bean.setQ19a3NoOfAdultsWithOtherIncomeRetainedIncomeCategoryButHadLessDollarAtFollowupOrExitAtEntry(BigInteger.valueOf(retainOtherIncomeCatLessAtAAThanAtEntry));
	if(retainOtherIncomeCatLessAtAAThanAtEntry !=0) {
		BigInteger retainIncomeAtAAThenAtEntryAmount = otherIncomeCatLessAtAAThanAtEntry.divide(BigInteger.valueOf(retainOtherIncomeCatLessAtAAThanAtEntry));
		q19a3Bean.setQ19a3AverageChangeInOtherIncomeRetainedIncomeCategoryButHadLessDollarAtFollowupOrExitAtEntry(retainIncomeAtAAThenAtEntryAmount);
		q19a3Bean.setQ19a3NoOfAdultsWithOtherIncomeRetainedIncomeCategoryButHadLessDollarAtFollowupOrExitAtEntry(BigInteger.valueOf(retainOtherIncomeCatLessAtAAThanAtEntry));
	}
	//#D
	q19a3Bean.setQ19a3NoOfAdultsWithOtherIncomeRetainedIncomeCategoryAndSameDollartFollowupOrExitAtEntry(BigInteger.valueOf(retainOtherIncomeCatSameAtAAThanAtEntry));
	if(retainOtherIncomeCatSameAtAAThanAtEntry !=0) {
		BigInteger retainIncomeCatSameAtAAThanAtEntryAmount = otherIncomeCatSameAtAAThanAtEntry.divide(BigInteger.valueOf(retainOtherIncomeCatSameAtAAThanAtEntry));
		q19a3Bean.setQ19a3AverageChangeInOtherIncomeRetainedIncomeCategoryAndSameDollartFollowupOrExitAtEntry(retainIncomeCatSameAtAAThanAtEntryAmount);
	}
	
	//#H
	q19a3Bean.setQ19a3NoOfAdultsWithOtherIncomeTotalAdult(allClientsBigInt);
	q19a3Bean.setQ19a3AverageChangeInOtherIncomeTotalAdult(BigInteger.ZERO);
	

	if(retainOtherIncomeCatGreaterAtAAThanAtEntry !=0) {
			//#E
			q19a3Bean.setQ19a3NoOfAdultsWithOtherIncomeRetainedIncomeCategoryAndIncreasedDollarAtFollowupOrExit(BigInteger.valueOf(retainOtherIncomeCatGreaterAtAAThanAtEntry));
			BigInteger retainIncomeCatGreater = BigInteger.valueOf(retainOtherIncomeCatGreaterAtAAThanAtEntry);
			BigInteger otherIncomeCatGreaterAtAAThanAtEntryAmount = otherIncomeCatGreaterAtAAThanAtEntry.divide(retainIncomeCatGreater);
			q19a3Bean.setQ19a3AverageChangeInOtherIncomeRetainedIncomeCategoryAndIncreasedDollarAtFollowupOrExit(otherIncomeCatGreaterAtAAThanAtEntryAmount);
			
			//#I
			BigInteger  otherIncomePerformaceMeasureAverage =  otherIncomePerformaceMeasure.divide(retainIncomeCatGreater);
			q19a3Bean.setQ19a3NoOfAdultsWithOtherIncomePerformanceMeasures(BigInteger.valueOf(retainOtherIncomeCatGreaterAtAAThanAtEntry));
			q19a3Bean.setQ19a3AverageChangeInOtherIncomePerformanceMeasures(otherIncomePerformaceMeasureAverage);
		
			//#J
			q19a3Bean.setQ19a3NoOfAdultsWithOtherIncomePercent(retainIncomeCatGreater.multiply(BigInteger.valueOf(100)).divide(allClientsBigInt));
	...
	if(noOfAdultsDidNotHaveTheOtherIncomeCategoryAtEntryAndGainedTheIncome != 0 && sumadultsDidNotHaveOtherIncomeCategoryAtEntryAndGainedTheIncome != BigInteger.ZERO) {
		BigInteger average = sumadultsDidNotHaveOtherIncomeCategoryAtEntryAndGainedTheIncome.divide(BigInteger.valueOf(noOfAdultsDidNotHaveTheOtherIncomeCategoryAtEntryAndGainedTheIncome));
		q19a3Bean.setQ19a3NoOfAdultsWithOtherIncomeDidNotHaveIncomeCategoryEntryAndGainedIncomeCategoryAtFollowupOrExit(BigInteger.valueOf(noOfAdultsDidNotHaveTheOtherIncomeCategoryAtEntryAndGainedTheIncome));
		q19a3Bean.setQ19a3AverageChangeInOtherIncomeDidNotHaveIncomeCategoryEntryAndGainedIncomeCategoryAtFollowupOrExit(average);
	}
	//#G
	q19a3Bean.setQ19a3NoOfAdultsWithOtherIncomeDidNotHaveIncomeCategoryAtEntryOrFollowupOrExit(BigInteger.valueOf(getSize(clientIds)));
