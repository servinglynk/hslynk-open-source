...
public class Q19a3DataBeanMaker extends BaseBeanMaker {
	...
	public static void populateEarnedIncome(Q19a3ClientCashIncomeChangeIncomeSourceByEntryDataBean q19a1ClientCashIncomeChangeIncomeSourceEntryTableDate, List<IncomeAndSourceModel> incomes,BigInteger allClientsBigInt) {
		...
		if(retainEarnedIncomeCatGreaterAtAAThanAtEntry !=0) {
				...
				//#J
				q19a1ClientCashIncomeChangeIncomeSourceEntryTableDate.setQ19a3NoOfAdltsWithEarnedIncomePercent(BigInteger.ZERO);
				q19a1ClientCashIncomeChangeIncomeSourceEntryTableDate.setQ19a3AverageChangeInEarnedIncomePercent(earnedIncomePerformaceMeasure.divide(allClientsBigInt));
			}
	...
	public static void populateOtherIncome(Q19a3ClientCashIncomeChangeIncomeSourceByEntryDataBean q19a1ClientCashIncomeChangeIncomeSourceEntryTableDate, List<IncomeAndSourceModel> incomes,BigInteger allClientsBigInt) {
		...
		if(retainOtherIncomeCatGreaterAtAAThanAtEntry !=0) {
				...
				//#J
				q19a1ClientCashIncomeChangeIncomeSourceEntryTableDate.setQ19a3NoOfAdultsWithOtherIncomePercent(BigInteger.ZERO);
				q19a1ClientCashIncomeChangeIncomeSourceEntryTableDate.setQ19a3AverageChangeInOtherIncomePercent(otherIncomePerformaceMeasure.divide(allClientsBigInt));
			}
		...
		List<IncomeAndSourceModel> didNotHaveOtherIncomeATEntryButNotAtAA = incomes.parallelStream().filter(income -> (StringUtils.equals("3",income.getDataCollectionStage()) || StringUtils.equals("5",income.getDataCollectionStage())) && (getFloat(income.getTotalmonthlyincome()) - getFloat(income.getEarnedamount())) ==0).collect(Collectors.toList());
		Set<String> clientIds = new HashSet<>();
...
public static void populateOverallIncomeIncome(Q19a3ClientCashIncomeChangeIncomeSourceByEntryDataBean q19a1Bean, List<IncomeAndSourceModel> incomes,BigInteger allClientsBigInt) {
		...
		if(retainOtherIncomeCatGreaterAtAAThanAtEntry !=0) {
				...
				//#J
				q19a1Bean.setQ19a3NumberOfAdultsWithAnyIncomePercent(BigInteger.ZERO);
				q19a1Bean.setQ19a3AverageChangeInOverallIncomePercent(otherIncomePerformaceMeasure.divide(allClientsBigInt));
			}
		Set<String> otherKeySetAtAA = otherIncomeMapAtAA.keySet();
		int noOfAdultsDidNotHaveTheOtherIncomeCategoryAtEntryAndGainedTheIncome = 0;
		BigInteger sumadultsDidNotHaveOtherIncomeCategoryAtEntryAndGainedTheIncome = BigInteger.ZERO;
