...
public class Q27eLengthOfParticipationYouthDataBeanMaker {
	...
	public static List<Q27eLengthOfParticipationYouthDataBean> getQ27eLengthOfParticipationYouthList(){
		...
		q27eLengthOfParticipationYouthTable.setQ27eTotalAtEntry(BigInteger.valueOf(0));
