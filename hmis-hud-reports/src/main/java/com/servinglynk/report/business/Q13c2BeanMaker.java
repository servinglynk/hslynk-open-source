...
public class Q13c2BeanMaker extends BaseBeanMaker {
	...
	public static List<Q13c2DataBean> getQ13c2NumberOfConditionsForStayerList(ReportData data){
		...
		List<DisabilitiesModel> disabilities = getEnrollmentFromDisabilitiesCountWithDate(data.getSchema(), query, sqlDate);
		...
		if(CollectionUtils.isNotEmpty(disabilitiesMissing)) {
	    	...
	    	q13c2Bean.setQ13c2InformationmissingWithChildAndAdults(BigInteger.valueOf(withOneAdultChildIntSize));
    	...
    	q13c2Bean.setQ13c2TotalSummed(data.getTotNumOfPersonServed());
