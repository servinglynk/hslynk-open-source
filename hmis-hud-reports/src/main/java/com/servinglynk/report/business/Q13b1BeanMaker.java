...
public class Q13b1BeanMaker extends BaseBeanMaker {
	...
	public static List<Q13b1DataBean> getQ13b1PhysicalAndMentalHealthConditionsAtExitList(ReportData data){
		...
		String mentalHealthQuery = " select enrollment_id from disabilities where datacollectionstage = '2' and disabilitytype='9' ";
    	...
    	String alcoholQuery = "select project_entry_id from disabilities where datacollectionstage = '2' and disabilitytype='10' and disabilityresponse='1' ";
    	...
    	String drugQuery = "select project_entry_id from disabilities where datacollectionstage = '2' and disabilitytype='10' and disabilityresponse='2'";
    	...
    	String alcoholAndDrugQuery = "select project_entry_id from disabilities where datacollectionstage = '2' and disabilitytype='10' and disabilityresponse='3' ";
    	...
    	String chronicHealthCondition = "select project_entry_id from disabilities where datacollectionstage = '2' and disabilitytype='7' ";
    	...
    	String hivaids = "select project_entry_id from disabilities where datacollectionstage = '2' and disabilitytype='8' ";
    	...
    	String developmentDisability = "select project_entry_id from disabilities where datacollectionstage = '2' and disabilitytype='6' ";
    	...
    	String physicalDisabilitiy = " select project_entry_id from disabilities where datacollectionstage = '2' and disabilitytype='5' ";
