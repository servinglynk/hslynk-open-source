...
public class Q25gTypeOfCashIncomeSourcesVeteransDataBeanMaker {
	
	public static List<Q25gTypeOfCashIncomeSourcesVeteransDataBean> getQ25gTypeOfCashIncomeSourcesVeteranList(){
		
		Q25gTypeOfCashIncomeSourcesVeteransDataBean q25gTypeOfCashIncomeSourcesVeteransTable = new Q25gTypeOfCashIncomeSourcesVeteransDataBean();
		...
		return Arrays.asList(q25gTypeOfCashIncomeSourcesVeteransTable);
