CREATE OR REPLACE FUNCTION lsa.fun_lsa_calculated_counts (IN reportId integer, IN project_group_code varchar)
RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN
...
*/
	...
	where n."Active" = B'1' and cd."Cohort" between 1 and 13
...
*/
	...
	where hhid."Active" = B'1' and cd."Cohort" between 1 and 13
		and pop."PopID" in (0,1,2,3,4,5,7,8,9,10) and pop."PopType" = 1
		and pop."SystemPath" is null
		and (
			 --for RRH and PSH, count only people who are housed in period
...
*/
	...
	where n."Active" = B'1' and  pop."PopID" in (0,1,2) and pop."SystemPath" is null and pop."PopType" = 1
...
*/
	...
	left outer join lsa."ref_Calendar" bnd on bnd."theDate" = bn.DateProvided
		and bnd."theDate" >= rpt."ReportStart" and bnd."theDate" <= rpt."ReportEnd"
		and n."ProjectType" = 1 and n."TrackingMethod" = 3
	where n."Active" = B'1' and pop."PopID" in (3,6) and pop."PopType" = 3
	group by n."ProjectID", rpt."ReportID", pop."PopID", pop."HHType";
...
*/
	...
	from lsa."tlsa_Enrollment" n
	left outer join v2020."exit" hx on cast (hx."enrollmentid" as varchar) = n."EnrollmentID" and hx.deleted is false and hx.parent_id is null
...
*/
	...
	left outer join v2020."exit" hx on hx."enrollmentid" = hn."id" and hx.deleted is false and hx.parent_id is null
