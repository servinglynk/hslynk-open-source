CREATE OR REPLACE FUNCTION lsa.fun_lsa_calculated_averages (IN reportId integer, IN project_group_code varchar)
RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN
...
Name:  8_1 to 8_8 lsa."lsa_Calculated" averages from LSAHousehold and LSAExit (File 8 of 10)
Date:  4/7/2020   
...
*/
	delete from lsa."lsa_Calculated";
	--AVERAGE DAYS IN ES/SH 
	insert into lsa."lsa_Calculated" ("Value", "Cohort", "Universe", "HHType"
