...
*/
	...
	inner join lsa."tlsa_HHID" hhid on hhid."HouseholdID" = n."HouseholdID" and hhid."Active" = B'1'
...
*/
	...
	, case 
		...
		, '5.3-5.4'
	from lsa."lsa_Report" rpt
	inner join lsa."tlsa_Enrollment" n on n."EntryDate" <= rpt."ReportEnd" and n."Active" = B'1'
	inner join 
...
*/
	...
	from lsa."tlsa_Person" lp
	inner join lsa."tlsa_Enrollment" chn on chn."PersonalID" = lp."PersonalID" and chn."CH" = B'1'
		 ...
		 (select HHTypes."PersonalID"
			...
			from --Level 1 - get distinct HHTypes for EST
					 (select distinct n."PersonalID"
						...
						from lsa."tlsa_Enrollment" n
						inner join lsa."tlsa_HHID" hhid on hhid."HouseholdID" = n."HouseholdID"
						where n."ProjectType" in (1,2,8) and n."Active" = B'1') HHTypes  
		 ...
		 (select HHTypes."PersonalID"
			...
			from --Level 1 - get distinct HHTypes for EST
					 (select distinct n."PersonalID"
						...
						from lsa."tlsa_Enrollment" n
						inner join lsa."tlsa_HHID" hhid on hhid."HouseholdID" = n."HouseholdID"
						where n."ProjectType" = 13 and n."Active" = B'1') HHTypes  
			group by HHTypes."PersonalID"
			) hh on hh."PersonalID" = lp."PersonalID";
		 ...
		 (select HHTypes."PersonalID"
			...
			from --Level 1 - get distinct HHTypes for EST
					 (select distinct n."PersonalID"
						...
						from lsa."tlsa_Enrollment" n
						inner join lsa."tlsa_HHID" hhid on hhid."HouseholdID" = n."HouseholdID"
						where n."ProjectType" = '3' and n."Active" = B'1') HHTypes  
			group by HHTypes."PersonalID"
			) hh on hh."PersonalID" = lp."PersonalID";
				...
				(select cast(replace(cast(sum(HHTypes.HHTypeEach) as varchar), '0', '') as int)
				 from 
					 (select distinct n."PersonalID"
						...
						from lsa."tlsa_Enrollment" n
						inner join lsa."tlsa_HHID" hhid on hhid."HouseholdID" = n."HouseholdID"
						where n."Active" = B'1' and n."ProjectType" in (1,2,8) and n."RelationshipToHoH" = 1) HHTypes  
				...
				(select cast(replace(cast(sum(HHTypes.HHTypeEach) as varchar), '0', '') as int)
				 from 
					 (select distinct n."PersonalID"
						...
						from lsa."tlsa_Enrollment" n
						inner join lsa."tlsa_HHID" hhid on hhid."HouseholdID" = n."HouseholdID"
						where n."Active" = B'1' and n."ProjectType" = 13 and n."RelationshipToHoH" = 1) HHTypes  
				where HHTypes."PersonalID" = lp."PersonalID")
			, -1) end	
		, "Step" = '5.13.2'
				...
				(select cast(replace(cast(sum(HHTypes.HHTypeEach) as varchar), '0', '') as int)
				 from 
					 (select distinct n."PersonalID"
						...
						from lsa."tlsa_Enrollment" n
						inner join lsa."tlsa_HHID" hhid on hhid."HouseholdID" = n."HouseholdID"
						where n."Active" = B'1' and n."ProjectType" = 3 and n."RelationshipToHoH" = 1) HHTypes  
				where HHTypes."PersonalID" = lp."PersonalID")
			, -1) end	
		, "Step" = '5.13.3'
	from lsa."tlsa_Person" lp where lsap."PersonalID" = lp."PersonalID";
				...
				(
				 ...
				 from 
					 (select distinct n."PersonalID"
						...
						from lsa."tlsa_Enrollment" n
						inner join lsa."tlsa_HHID" hhid on hhid."HouseholdID" = n."HouseholdID"
						where n."Active" = B'1' and n."ProjectType" in (1,2,8)
				...
				(
				 ...
				 from 
					 (select distinct n."PersonalID"
						...
						from lsa."tlsa_Enrollment" n
						inner join lsa."lsa_Report" rpt on n."Active" = B'1'
						inner join lsa."tlsa_HHID" hhid on hhid."HouseholdID" = n."HouseholdID"
				...
				(
				 ...
				 from 
					 (select distinct n."PersonalID"
						, case when hhid."ActiveHHType" = 1 then 1000
							when hhid."ActiveHHType" = 2 then 200
					                else 9 end as HHTypeEach						from lsa."tlsa_Enrollment" n
					inner join lsa."tlsa_HHID" hhid on hhid."HouseholdID" = n."HouseholdID"
						where n."Active" = B'1' and n."ProjectType" = 3 and n."MoveInDate" is not null 
							and (n."ExitDate" is null or n."ExitDate" > (select "ReportStart" from lsa."lsa_Report"))) HHTypes  
					where HHTypes."PersonalID" = lp."PersonalID")
				, -1) end	
		, "Step" = '5.14.3'
				...
				(
				 ...
				 from 
					 (select distinct n."PersonalID"
						...
						from lsa."tlsa_Enrollment" n
						inner join lsa."tlsa_HHID" hhid on hhid."HouseholdID" = n."HouseholdID"
						where n."Active" = B'1' and n."ProjectType" in (1,2,8) and n."ActiveAge" between 18 and 65
							and (n."ExitDate" is null or n."ExitDate" > (select "ReportStart" from lsa."lsa_Report"))) HHTypes  
					where HHTypes."PersonalID" = lp."PersonalID")
				, -1) end	
		, "Step" = '5.15.1'
				...
				(
				 ...
				 from 
					 (select distinct n."PersonalID"
						...
						from lsa."tlsa_Enrollment" n
						inner join lsa."tlsa_HHID" hhid on hhid."HouseholdID" = n."HouseholdID"
						where n."Active" = B'1' and n."ProjectType" in (1,2,8) and n."RelationshipToHoH" = 1
							and (n."ExitDate" is null or n."ExitDate" > (select "ReportStart" from lsa."lsa_Report"))) HHTypes  
				where HHTypes."PersonalID" = lp."PersonalID")
				, -1) end	
		, "Step" = '5.16.1';
...
*/                 
	...
	set "HHChronic" = (select max(
			...
			from lsa."tlsa_Person" lp
			inner join lsa."tlsa_Enrollment" n on n."PersonalID" = lp."PersonalID" and n."Active" = B'1'
		...
		, "HHAdultAge" = (select 
				...
				from lsa."tlsa_Enrollment" n 
				where n."HouseholdID" = hhid."HouseholdID" and n."Active" = B'1') 
		, "AC3Plus" = (select case sum(case when n."ActiveAge" <= 17 and hh."ActiveHHType" = 2 then 1
				...
				from lsa."tlsa_Enrollment" n 
				inner join lsa."tlsa_HHID" hh on hh."HouseholdID" = n."HouseholdID"
				where n."Active" = B'1' and n."HouseholdID" = hhid."HouseholdID") 
		, "Step" = '5.17.1'
...
*/
		...
		inner join (select distinct lp."PersonalID"
			, (select cast (sum(distinct
				...
				inner join lsa."tlsa_Enrollment" n on hhid."HouseholdID" = n."HouseholdID"
						and n."Active" = B'1' and n."ProjectType" in (1,2,8)
	...
	from lsa."tlsa_Person" lp
		inner join (select distinct lp."PersonalID"
			, (select cast(sum(distinct
				...
				from lsa."tlsa_HHID" hhid
				inner join lsa."tlsa_Enrollment" n on hhid."HouseholdID" = n."HouseholdID"
						and n."Active" = B'1' and n."ProjectType" = 13
				where n."PersonalID" = lp."PersonalID") "HHChronicEST"
			, (select cast(sum(distinct
					case when hhid."HHVet" = 0 then 0 
						when hhid."ActiveHHType" = 1 then 1000
	...
	from lsa."tlsa_Person" lp
		inner join (select distinct lp."PersonalID"
			, (select cast(sum(distinct
				...
				from lsa."tlsa_HHID" hhid
				inner join lsa."tlsa_Enrollment" n on hhid."HouseholdID" = n."HouseholdID"
						and n."Active" = B'1' and n."ProjectType" = 3
	...
	set "HHAdultAgeAOEST" = coalesce((select case when min(hhid."HHAdultAge") between 18 and 24
				...
				where n."PersonalID" = lp."PersonalID" and n."Active" = B'1'), -1)
	...
	set "AC3PlusEST" = coalesce((select max(hhid."AC3Plus") 
				from lsa."tlsa_HHID" hhid
					inner join lsa."tlsa_Enrollment" n on hhid."HouseholdID" = n."HouseholdID"
				where n."PersonalID" = lp."PersonalID"
					and n."ProjectType" in (1,2,8) and n."Active" = B'1'), 0)
		, "AC3PlusRRH" = coalesce((select max(hhid."AC3Plus") 
				from lsa."tlsa_HHID" hhid
					inner join lsa."tlsa_Enrollment" n on hhid."HouseholdID" = n."HouseholdID"
				where n."PersonalID" = lp."PersonalID"
					and n."ProjectType" = 13 and n."Active" = B'1'), 0)		
		, "AC3PlusPSH" = coalesce((select max(hhid."AC3Plus") 
				from lsa."tlsa_HHID" hhid
					inner join lsa."tlsa_Enrollment" n on hhid."HouseholdID" = n."HouseholdID"
				where n."PersonalID" = lp."PersonalID"
					and n."ProjectType" = 3 and n."Active" = B'1'), 0)
		, "Step" = '5.18.8';
