...
select distinct hoh."householdid", hoh."client_id", hoh."id"
	...
	, case when p."projecttype" = '1' and p."trackingmethod" = '3' and hx."exitdate" > dateadd('d', 1, bn."LastBednight"::date)
...
where hoh."relationshiptohoh" = '1'
	...
	and (p."operatingenddate" is null 
		...
		or (hoh."entrydate" < p."operatingenddate" and p."operatingenddate" >= '2012-10-1'))
