CREATE OR REPLACE FUNCTION lsa.fun_create_output_tables()
RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CLUSTER lsa."lsa_Project" USING "pk_lsa_Project";
/*
...
CLUSTER lsa."lsa_Organization" USING "pk_lsa_Organization";
/*
...
create table lsa."lsa_Funder"(
	...
	CLUSTER lsa."lsa_Funder" USING "pk_lsa_Funder";
...
create table lsa."lsa_ProjectCoC"(
	...
	CLUSTER lsa."lsa_ProjectCoC" USING "pk_lsa_ProjectCoC";
...
create table lsa."lsa_Inventory"(
 ...
 CLUSTER lsa."lsa_Inventory" USING "pk_lsa_Inventory";
