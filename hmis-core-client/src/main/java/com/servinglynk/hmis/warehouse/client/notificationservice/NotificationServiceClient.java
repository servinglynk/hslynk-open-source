...
public class NotificationServiceClient extends CoreClientBase implements INotificationServiceClient {
	...
	public Notification createNotification(Notification notification) {
		...
		Notification responseEntity = restTemplate.postForObject("http://hmiselb.aws.hmislynk.com/hmis-notification-service/rest/notifications", notification, Notification.class);
