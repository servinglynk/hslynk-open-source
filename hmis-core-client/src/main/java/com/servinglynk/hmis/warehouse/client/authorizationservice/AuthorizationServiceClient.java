...
public class AuthorizationServiceClient extends CoreClientBase implements IAuthorizationClient {
	...
	public ApiMethodAuthorizationCheck checkApiAuthorization(ApiMethodAuthorizationCheck authCheck) throws Exception {
		...
		HttpEntity entity = new HttpEntity(headers);
		 ResponseEntity<ApiMethodAuthorizationCheck> response = restTemplate.exchange("http://internal.hmislynk.com:20999/hmis-user-service/rest/apimethodauthcheck/"+authCheck.getApiMethodId(),HttpMethod.GET,entity ,ApiMethodAuthorizationCheck.class);
