...
public class DisabilitiesServiceImpl extends ServiceBase implements DisabilitiesService  {
   ...
   public Disabilities createDisabilities(Disabilities disabilities,UUID enrollmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2020.Disabilities pDisabilities = DisabilitiesConverter.modelToEntity(disabilities, null);
   ...
   public Disabilities updateDisabilities(Disabilities disabilities,UUID enrollmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2020.Enrollment pEnrollment = daoFactory.getEnrollmentDao().getEnrollmentById(enrollmentId);
       if(pEnrollment == null) throw new EnrollmentNotFound();
       com.servinglynk.hmis.warehouse.model.v2020.Disabilities pDisabilities = daoFactory.getDisabilitiesDao().getDisabilitiesById(disabilities.getDisabilitiesId());
   ...
   public Disabilities deleteDisabilities(UUID disabilitiesId,String caller){
       com.servinglynk.hmis.warehouse.model.v2020.Disabilities pDisabilities = daoFactory.getDisabilitiesDao().getDisabilitiesById(disabilitiesId);
       if(pDisabilities==null) throw new DisabilitiesNotFoundException();
   ...
   public DisabilitiesList getAllEnrollmentDisabilitiess(UUID enrollmentId,Integer startIndex, Integer maxItems){
	   DisabilitiesList disabilities = new DisabilitiesList();
        List<com.servinglynk.hmis.warehouse.model.v2020.Disabilities> entities = daoFactory.getDisabilitiesDao().getAllEnrollmentDisabilitiess(enrollmentId,startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.v2020.Disabilities entity : entities){
