...
public class EmploymentConverter  extends BaseConverter {
   ...
   public static com.servinglynk.hmis.warehouse.model.v2020.Employment modelToEntity (Employment model ,com.servinglynk.hmis.warehouse.model.v2020.Employment entity) {
       if(entity==null) entity = new com.servinglynk.hmis.warehouse.model.v2020.Employment();
   ...
   public static Employment entityToModel (com.servinglynk.hmis.warehouse.model.v2020.Employment entity) {
       ...
       if(entity.getParentId() ==null && entity.getEnrollmentid()!=null && entity.getEnrollmentid().getClient()!=null) {
    	   model.addLink(new ActionLink("history","/clients/"+entity.getEnrollmentid().getClient().getId()+"/enrollments/"+entity.getEnrollmentid().getId()+"/employments/"+entity.getId()+"/history"));
       }
       return model;
   }
