...
public class HmisHouseHoldServiceImpl extends ServiceBase implements HmisHouseHoldService {
	...
	@Transactional
	public com.servinglynk.hmis.warehouse.model.v2020.HmisHousehold createHmisHousehold(Client client,HmisHousehold model,Account caller){
		com.servinglynk.hmis.warehouse.model.v2020.HmisHousehold entity = new com.servinglynk.hmis.warehouse.model.v2020.HmisHousehold();
		entity.setHeadOfHousehold(client);
		entity.setDedupClientId(client.getDedupClientId());
		if(model.getSourceSystemHouseHoldId()!=null) entity.setSourceSystemHouseHoldId(model.getSourceSystemHouseHoldId());
	...
	public void deleteHouseHold(UUID householeId) {
		com.servinglynk.hmis.warehouse.model.v2020.HmisHousehold entity = daoFactory.getHmisHouseholdDao().getHouseHoldById(householeId);
	...
	public HmisHouseholds getAllHouseHolds(Integer startIndex, Integer maxItems) {
		...
		List<com.servinglynk.hmis.warehouse.model.v2020.HmisHousehold> entities = daoFactory.getHmisHouseholdDao().getAllHouseHolds(startIndex, maxItems);
		for(com.servinglynk.hmis.warehouse.model.v2020.HmisHousehold entity : entities) {
	...
	public void removeHouseHoldMember(UUID householdId, UUID memberid, Account caller) {
		com.servinglynk.hmis.warehouse.model.v2020.HmisHousehold entity = daoFactory.getHmisHouseholdDao().getHouseHoldById(householdId);
