...
public class PathstatusConverter  extends BaseConverter {
   ...
   public static com.servinglynk.hmis.warehouse.model.v2020.Pathstatus modelToEntity (Pathstatus model ,com.servinglynk.hmis.warehouse.model.v2020.Pathstatus entity) {
       if(entity==null) entity = new com.servinglynk.hmis.warehouse.model.v2020.Pathstatus();
 ...
 entity.setSubmissionDate(model.getSubmissionDate());
   ...
   public static Pathstatus entityToModel (com.servinglynk.hmis.warehouse.model.v2020.Pathstatus entity) {
