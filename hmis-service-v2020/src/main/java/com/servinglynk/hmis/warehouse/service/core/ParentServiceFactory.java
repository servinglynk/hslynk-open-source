...
public interface ParentServiceFactory  extends BaseServiceFactory {
	...
	AssessmentQuestionService  getAssessmentQuestionService();
	AssessmentResultService  getAssessmentResultService();
	CurrentLivingSituationService getCurrentLivingSituationService();
	EventService getEventService();
	HistoryService getHistoryService();
	HmisHouseHoldService getHmisHouseHoldService();
}