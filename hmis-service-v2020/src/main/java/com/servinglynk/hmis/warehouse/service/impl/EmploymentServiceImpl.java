...
public class EmploymentServiceImpl extends ServiceBase implements EmploymentService  {
   ...
   public Employment createEmployment(Employment employment,UUID enrollmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2020.Employment pEmployment = EmploymentConverter.modelToEntity(employment, null);
   ...
   public Employment updateEmployment(Employment employment,UUID enrollmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2020.Enrollment pEnrollment = daoFactory.getEnrollmentDao().getEnrollmentById(enrollmentId);
       if(pEnrollment == null) throw new EnrollmentNotFound();
       com.servinglynk.hmis.warehouse.model.v2020.Employment pEmployment = daoFactory.getEmploymentDao().getEmploymentById(employment.getEmploymentId());
   ...
   public Employment deleteEmployment(UUID employmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2020.Employment pEmployment = daoFactory.getEmploymentDao().getEmploymentById(employmentId);
       if(pEmployment==null) throw new EmploymentNotFoundException();
   ...
   public Employments getAllEnrollmentEmployments(UUID enrollmentId,Integer startIndex, Integer maxItems){
       Employments employments = new Employments();
        List<com.servinglynk.hmis.warehouse.model.v2020.Employment> entities = daoFactory.getEmploymentDao().getAllEnrollmentEmployments(enrollmentId,startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.v2020.Employment entity : entities){
