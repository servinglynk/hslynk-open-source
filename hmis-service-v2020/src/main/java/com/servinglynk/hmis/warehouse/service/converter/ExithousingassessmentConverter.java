...
public class ExithousingassessmentConverter  extends BaseConverter {
   ...
   public static com.servinglynk.hmis.warehouse.model.v2020.Exithousingassessment modelToEntity (Exithousingassessment model ,com.servinglynk.hmis.warehouse.model.v2020.Exithousingassessment entity) {
       if(entity==null) entity = new com.servinglynk.hmis.warehouse.model.v2020.Exithousingassessment();
 ...
 if(model.getSubsidyinformation()!=null)
   ...
   public static Exithousingassessment entityToModel (com.servinglynk.hmis.warehouse.model.v2020.Exithousingassessment entity) {
