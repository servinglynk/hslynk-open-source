...
public class VeteranInfoServiceImpl extends ServiceBase implements VeteranInfoService  {
   ...
   public VeteranInfo createVeteranInfo(VeteranInfo veteranInfo,UUID clientId,String caller){
       ...
       com.servinglynk.hmis.warehouse.model.v2020.ClientVeteranInfo pVeteranInfo = VeteranInfoConverter.modelToEntity(veteranInfo, null);
   ...
   public VeteranInfo updateVeteranInfo(VeteranInfo veteranInfo,UUID clientId,String caller){
       ...
       com.servinglynk.hmis.warehouse.model.v2020.ClientVeteranInfo pVeteranInfo = daoFactory.getVeteranInfoDao().getVeteranInfoById(veteranInfo.getVeteranInfoId());
   ...
   public VeteranInfo deleteVeteranInfo(UUID veteranInfoId,String caller){
       com.servinglynk.hmis.warehouse.model.v2020.ClientVeteranInfo pVeteranInfo = daoFactory.getVeteranInfoDao().getVeteranInfoById(veteranInfoId);
       if(pVeteranInfo==null) throw new VeteranInfoNotFoundException();
   ...
   public VeteranInfos getAllClientVeteranInfos(UUID clientId,Integer startIndex, Integer maxItems){
       VeteranInfos veteranInfos = new VeteranInfos();
        List<com.servinglynk.hmis.warehouse.model.v2020.ClientVeteranInfo> entities = daoFactory.getVeteranInfoDao().getAllClientVeteranInfos(clientId,startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.v2020.ClientVeteranInfo entity : entities){
