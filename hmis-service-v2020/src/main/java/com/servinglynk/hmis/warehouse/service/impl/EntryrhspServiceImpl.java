...
public class EntryrhspServiceImpl extends ServiceBase implements EntryrhspService  {
   ...
   public Entryrhsp createEntryrhsp(Entryrhsp entryrhsp,UUID enrollmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp pEntryrhsp = EntryrhspConverter.modelToEntity(entryrhsp, null);
   ...
   public Entryrhsp updateEntryrhsp(Entryrhsp entryrhsp,UUID enrollmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2020.Enrollment pEnrollment = daoFactory.getEnrollmentDao().getEnrollmentById(enrollmentId);
       if(pEnrollment == null) throw new EnrollmentNotFound();
       com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp pEntryrhsp = daoFactory.getEntryrhspDao().getEntryrhspById(entryrhsp.getEntryrhspId());
   ...
   public Entryrhsp deleteEntryrhsp(UUID entryrhspId,String caller){
       com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp pEntryrhsp = daoFactory.getEntryrhspDao().getEntryrhspById(entryrhspId);
       if(pEntryrhsp==null) throw new EntryrhspNotFoundException();
   ...
   public Entryrhsps getAllEnrollmentEntryrhsps(UUID enrollmentId,Integer startIndex, Integer maxItems){
       Entryrhsps entryrhsps = new Entryrhsps();
        List<com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp> entities = daoFactory.getEntryrhspDao().getAllEnrollmentEntryrhsps(enrollmentId,startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp entity : entities){
