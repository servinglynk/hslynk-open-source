...
public class ProjectDaoImpl extends ParentDaoImpl implements ProjectDao {
		...
		if(projects !=null && projects.size() > 0)
		{
			for(Project project : projects)
			{
				...
				try {
					...
					manageGolbalProjects(projectModel,domain.getUpload().getProjectGroupCode(), domain.getUserId(), "2015");
	...
	public com.servinglynk.hmis.warehouse.model.v2015.Project getModelObject(ExportDomain domain, Project project ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2015.Project modelFromDB = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			modelFromDB = (com.servinglynk.hmis.warehouse.model.v2015.Project) getModel(com.servinglynk.hmis.warehouse.model.v2015.Project.class, project.getProjectID(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
		
		if(modelFromDB == null) {
			modelFromDB = new com.servinglynk.hmis.warehouse.model.v2015.Project();
	...
	public void manageGolbalProjects(com.servinglynk.hmis.warehouse.model.v2015.Project project,String projectGroupCode,UUID userId,String schemaYear) {
	...
	public void hydrateHBASE(SyncDomain syncDomain) {
	   ...
	   public List<com.servinglynk.hmis.warehouse.model.v2015.Project> getAllProjects(String projectGroupCode,Integer startIndex, Integer maxItems){
	       DetachedCriteria criteria=DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2015.Project.class);
