...
public class ServiceFaReferralDaoImpl extends ParentDaoImpl implements ServiceFaReferralDao{
	...
	public com.servinglynk.hmis.warehouse.model.v2015.ServiceFaReferral getModelObject(ExportDomain domain, Services services ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2015.ServiceFaReferral modelFromDB = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			modelFromDB = (com.servinglynk.hmis.warehouse.model.v2015.ServiceFaReferral) getModel(com.servinglynk.hmis.warehouse.model.v2015.ServiceFaReferral.class, services.getServicesID(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
		
		if(modelFromDB == null) {
			modelFromDB = new com.servinglynk.hmis.warehouse.model.v2015.ServiceFaReferral();
			modelFromDB.setId(UUID.randomUUID());
			modelFromDB.setRecordToBeInserted(true);
		}
		com.servinglynk.hmis.warehouse.model.v2015.ServiceFaReferral model = new com.servinglynk.hmis.warehouse.model.v2015.ServiceFaReferral();
