...
public class ProjectGroupDaoImpl extends ParentDaoImpl implements ProjectGroupDao {
	...
	public void deleteProjectGroupMap(ProjectProjectGroupMapEntity entity){
	   ...
	   public long getProjectGroupCount(){
	       DetachedCriteria criteria=DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2015.ProjectGroupEntity.class);
	       return countRows(criteria);
	   }

	   public List<com.servinglynk.hmis.warehouse.model.v2015.ProjectGroupEntity> getAllProjectGroups(Integer startIndex, Integer maxItems){
	       DetachedCriteria criteria=DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2015.ProjectGroupEntity.class);
	       return (List<com.servinglynk.hmis.warehouse.model.v2015.ProjectGroupEntity>) findByCriteria(criteria,startIndex,maxItems);
	   }
