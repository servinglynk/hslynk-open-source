...
public class RhybcpstatusDaoImpl extends ParentDaoImpl implements
	...
	public com.servinglynk.hmis.warehouse.model.v2015.RhybcpStatus getModelObject(ExportDomain domain, RHYBCPStatus rhybcpStatus ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2015.RhybcpStatus modelFromDB = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			modelFromDB = (com.servinglynk.hmis.warehouse.model.v2015.RhybcpStatus) getModel(com.servinglynk.hmis.warehouse.model.v2015.RhybcpStatus.class, rhybcpStatus.getRHYBCPStatusID(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
		
		if(modelFromDB == null) {
			modelFromDB = new com.servinglynk.hmis.warehouse.model.v2015.RhybcpStatus();
			modelFromDB.setId(UUID.randomUUID());
			modelFromDB.setRecordToBeInserted(true);
		}
		com.servinglynk.hmis.warehouse.model.v2015.RhybcpStatus model = new com.servinglynk.hmis.warehouse.model.v2015.RhybcpStatus();
	...
	public void hydrateHBASE(SyncDomain syncDomain) {
	   ...
	   public com.servinglynk.hmis.warehouse.model.v2015.RhybcpStatus getRhybcpstatusById(UUID rhybcpstatusId){ 
		      ...
		      List<com.servinglynk.hmis.warehouse.model.v2015.RhybcpStatus> entities = (List<com.servinglynk.hmis.warehouse.model.v2015.RhybcpStatus>) findByCriteria(criteria);
