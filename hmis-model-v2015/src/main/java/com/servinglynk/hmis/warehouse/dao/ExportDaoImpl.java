...
public class ExportDaoImpl extends ParentDaoImpl implements ExportDao {
	...
	public void hydrateStaging(ExportDomain domain) {
		...
		Data data=new Data();
		com.servinglynk.hmis.warehouse.model.v2015.Export exportModel  = getModelObject(domain, export,data);
...
//		com.servinglynk.hmis.warehouse.model.staging.HmisUser user = (com.servinglynk.hmis.warehouse.model.staging.HmisUser) get(com.servinglynk.hmis.warehouse.model.staging.HmisUser.class, upload.getUser().getId());
	//	exportModel.setUser(user);
		com.servinglynk.hmis.warehouse.model.v2015.Source sourceEntity = (com.servinglynk.hmis.warehouse.model.v2015.Source) getModel(com.servinglynk.hmis.warehouse.model.v2015.Source.class, domain.getSource().getSourceID(),getProjectGroupCode(domain),false);
	...
	public com.servinglynk.hmis.warehouse.model.v2015.Export getModelObject(ExportDomain domain, Export export ,Data data) {
		com.servinglynk.hmis.warehouse.model.v2015.Export exportModel = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			exportModel = (com.servinglynk.hmis.warehouse.model.v2015.Export) getModel(com.servinglynk.hmis.warehouse.model.v2015.Export.class, export.getExportID(), getProjectGroupCode(domain),false);
