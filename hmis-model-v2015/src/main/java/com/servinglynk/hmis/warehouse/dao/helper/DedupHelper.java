...
public class DedupHelper {
	...
	public String getDedupedClient(com.servinglynk.hmis.warehouse.model.stagv2015.Client client) {
		try {
	...
	public String getDedupedClient(com.servinglynk.hmis.warehouse.model.v2015.Client client) {
		try {
		 	RestTemplate restTemplate = new RestTemplate();
...
//    	}
    ...
    public static void main(String args[]) {
    	...
    	com.servinglynk.hmis.warehouse.model.stagv2015.Client client = new com.servinglynk.hmis.warehouse.model.stagv2015.Client();
