...
public class EducationDaoImpl extends ParentDaoImpl implements EducationDao {
	...
	public void hydrateStaging(ExportDomain domain) {
		...
		if(educationList!=null && !educationList.isEmpty())
		{
			...
			{
				com.servinglynk.hmis.warehouse.model.v2015.Education educationModel = getModelObject(domain, education, data);
				...
				Enrollment enrollmentModel = (Enrollment) getModel(Enrollment.class, education.getProjectEntryID(),getProjectGroupCode(domain),true);
	...
	public com.servinglynk.hmis.warehouse.model.v2015.Education getModelObject(ExportDomain domain, Education education ,Data data) {
		com.servinglynk.hmis.warehouse.model.v2015.Education educationModel = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			educationModel = (com.servinglynk.hmis.warehouse.model.v2015.Education) getModel(com.servinglynk.hmis.warehouse.model.v2015.Education.class, education.getEducationID(), getProjectGroupCode(domain),false);
