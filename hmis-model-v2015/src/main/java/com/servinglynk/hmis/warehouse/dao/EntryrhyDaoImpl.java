	...
	public void hydrateStaging(ExportDomain domain) {
		...
		if (entryRhy != null && entryRhy.size() > 0) {
			for (EntryRHY entryRhys : entryRhy) {
				...
				entryRhyModel.setCountOutReachReferralApproaches(EntryrhyCounBasicDataGenerator.getStringValue(entryRhys.getCountOutreachReferralApproaches()));
...
//				entryRhyModel.setEnrollmentid(enrollmentid);
				entryRhyModel.setExchangeForSex(BasicDataGenerator.getStringValue(entryRhys.getExchangeForSex())));
				entryRhyModel.setExchangeForSexPastThreeMonths(BasicDataGenerator.getStringValue(entryRhys.getExchangeForSexPastThreeMonths())));
//				entryRhyModel.setExport(export);
				entryRhyModel.setFormerlyWardChildWelfrForestCare(BasicDataGenerator.getStringValue(entryRhys.getFormerWardChildWelfare())));
				entryRhyModel.setFormerlyWardOfJuvenileJustice(BasicDataGenerator.getStringValue(entryRhys.getFormerWardJuvenileJustice())));
				entryRhyModel.setHealthIssuesFamilyMbr(BasicDataGenerator.getStringValue(entryRhys.getHealthIssuesFam())));
				entryRhyModel.setHealthIssuesYouth(BasicDataGenerator.getStringValue(entryRhys.getHealthIssuesYouth())));
				entryRhyModel.setHouseHoldDynamics(BasicDataGenerator.getStringValue(entryRhys.getHouseholdDynamics())));
				entryRhyModel.setHousingIssuesFamilyMbr(BasicDataGenerator.getStringValue(entryRhys.getHousingIssuesFam())));
				entryRhyModel.setHousingIssuesYouth(BasicDataGenerator.getStringValue(entryRhys.getHousingIssuesYouth())));
				entryRhyModel.setId(entryRhyUUID);
				entryRhyModel.setIncarceratedParent(BasicDataGenerator.getStringValue(entryRhys.getIncarceratedParent())));
				entryRhyModel.setIncarceratedParentStatus(BasicDataGenerator.getStringValue(entryRhys.getIncarceratedParentStatus())));
				entryRhyModel.setInsufficientIncomeToSupportYouth(BasicDataGenerator.getStringValue(entryRhys.getInsufficientIncome())));
				entryRhyModel.setLaborExploitPastThreeMonths(BasicDataGenerator.getStringValue(entryRhys.getLaborExploitPastThreeMonths())));
				entryRhyModel.setMentalDisabilityFamilyMbr(BasicDataGenerator.getStringValue(entryRhys.getMentalDisabilityFam())));
				entryRhyModel.setMentalDisabilityYouth(BasicDataGenerator.getStringValue(entryRhys.getMentalDisabilityYouth())));
				entryRhyModel.setMentalHealthIssuesFamilyMbr(BasicDataGenerator.getStringValue(entryRhys.getMentalHealthIssuesFam())));
				entryRhyModel.setMentalHealthIssuesYouth(BasicDataGenerator.getStringValue(entryRhys.getMentalHealthIssuesYouth())));
				entryRhyModel.setMonthsChildWelfrForestCare(BasicDataGenerator.getStringValue(entryRhys.getChildWelfareMonths())));
//				entryRhyModel.setParentId(parentId);
				entryRhyModel.setPhysicalDisabilityFamilyMbr(BasicDataGenerator.getStringValue(entryRhys.getPhysicalDisabilityFam())));
				entryRhyModel.setPhysicalDisabilityYouth(BasicDataGenerator.getStringValue(entryRhys.getPhysicalDisabilityYouth()));
				entryRhyModel.setReferralSource(BasicDataGenerator.getStringValue(entryRhys.getReferralSource())));
				entryRhyModel.setSchoolEducationIssuesFamilyMbr(BasicDataGenerator.getStringValue(entryRhys.getSchoolEducationalIssuesFam())));
				entryRhyModel.setSchoolEducationIssuesYouth(BasicDataGenerator.getStringValue(entryRhys.getSchoolEducationalIssuesYouth())));
				entryRhyModel.setSexualOrientatiionGenderIdentityFamilyMbr(BasicDataGenerator.getStringValue(entryRhys.getSexualOrientationGenderIDFam())));
				entryRhyModel.setSexualOrientatiionGenderIdentityYouth(BasicDataGenerator.getStringValue(entryRhys.getSexualOrientationGenderIDFam())));
				entryRhyModel.setSexualOrientation(BasicDataGenerator.getStringValue(entryRhys.getSexualOrientation())));
				entryRhyModel.setUnemployementFamilyMbr(BasicDataGenerator.getStringValue(entryRhys.getUnemploymentFam())));  ;
				entryRhyModel.setUnemployementYouth(BasicDataGenerator.getStringValue(entryRhys.getUnemploymentYouth())));
...
//				entryRhyModel.setVersion(version);
				entryRhyModel.setWorkPlacePromiseDifference(BasicDataGenerator.getStringValue(entryRhys.getWorkplacePromiseDifference())));
				entryRhyModel.setWorkPlaceViolenceThreat(BasicDataGenerator.getStringValue(entryRhys.getWorkPlaceViolenceThreats())));
				entryRhyModel.setYearsChildWelfrForestCare(BasicDataGenerator.getStringValue(entryRhys.getChildWelfareYears())));
				entryRhyModel.setYearsJuvenileJustice(BasicDataGenerator.getStringValue(entryRhys.getJuvenileJusticeYears())));
