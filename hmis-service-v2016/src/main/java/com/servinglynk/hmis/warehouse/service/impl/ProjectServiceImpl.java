...
public class ProjectServiceImpl extends ServiceBase implements ProjectService  {
   ...
   public Project createProject(Project project,String caller){
       ...
       com.servinglynk.hmis.warehouse.model.v2016.Project cProject =null;
       ...
       baseProject.setSchemaYear(2016);
       project.setProjectId(pProject.getId());
       }else {
          project.setProjectId(cProject.getId());
       }
       serviceFactory.getGlobalProjectService().manageGlobalProjects(ProjectConverter.modelToGlobalProject(project), "2016", AccountConverter.convertToAccount(user));
