...
public class OrganizationServiceImpl extends ServiceBase implements OrganizationService  {
   ...
   public Organization createOrganization(Organization organization,String caller){
       com.servinglynk.hmis.warehouse.model.v2016.Organization pOrganization = OrganizationConverter.modelToEntity(organization, null);
   ...
   public Organization updateOrganization(Organization organization,String caller){
       com.servinglynk.hmis.warehouse.model.v2016.Organization pOrganization = daoFactory.getOrganizationDao().getOrganizationById(organization.getOrganizationId());
   ...
   public Organization deleteOrganization(UUID organizationId,String caller){
       com.servinglynk.hmis.warehouse.model.v2016.Organization pOrganization = daoFactory.getOrganizationDao().getOrganizationById(organizationId);
       if(pOrganization==null) throw new OrganizationNotFoundException();
   ...
   public Organizations getAllOrganizations(String projectGroupCode,Integer startIndex, Integer maxItems){
       Organizations organizations = new Organizations();
        List<com.servinglynk.hmis.warehouse.model.v2016.Organization> entities = daoFactory.getOrganizationDao().getAllOrganizations(projectGroupCode,startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.v2016.Organization entity : entities){
