...
public class FunderServiceImpl extends ServiceBase implements FunderService  {
   ...
   public Funder createFunder(Funder funder,UUID projectId,String caller){
       com.servinglynk.hmis.warehouse.model.v2017.Funder pFunder = FunderConverter.modelToEntity(funder, null);
   ...
   public Funder updateFunder(Funder funder,UUID projectId,String caller){
	   com.servinglynk.hmis.warehouse.model.v2017.Project pProject = daoFactory.getProjectDao().getProjectById(projectId);
       if(pProject == null) throw new ProjectNotFoundException();
       com.servinglynk.hmis.warehouse.model.v2017.Funder pFunder = daoFactory.getFunderDao().getFunderById(funder.getFunderId());
   ...
   public Funder deleteFunder(UUID funderId,String caller){
       com.servinglynk.hmis.warehouse.model.v2017.Funder pFunder = daoFactory.getFunderDao().getFunderById(funderId);
       if(pFunder==null) throw new FunderNotFoundException();
   ...
   public Funders getAllProjectFunders(UUID projectId,Integer startIndex, Integer maxItems){
       Funders funders = new Funders();
        List<com.servinglynk.hmis.warehouse.model.v2017.Funder> entities = daoFactory.getFunderDao().getAllProjectFunders(projectId,startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.v2017.Funder entity : entities){
