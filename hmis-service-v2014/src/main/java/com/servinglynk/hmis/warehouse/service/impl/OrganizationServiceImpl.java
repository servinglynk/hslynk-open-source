...
public class OrganizationServiceImpl extends ServiceBase implements OrganizationService  {
   ...
   public Organizations getAllOrganizations(String projectGroupCode,Integer startIndex, Integer maxItems){
       Organizations organizations = new Organizations();
        List<com.servinglynk.hmis.warehouse.model.v2014.Organization> entities = daoFactory.getOrganizationDao().getAllOrganizations(projectGroupCode,startIndex,maxItems);
