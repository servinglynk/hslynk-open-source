...
public class ClientServiceImpl extends ServiceBase implements ClientService {
	...
	@Override
	@Transactional
	public Client createClient(Client client, String caller) throws Exception {
	...
	@Override
	@Transactional
	public Client updateClient(Client client, String caller) throws Exception {
	...
	public Clients getAllClients(String projectGroupCode,Integer startIndex, Integer maxItems) {
		List<com.servinglynk.hmis.warehouse.model.v2014.Client> clientsList = daoFactory.getClientDao().getAllClients(projectGroupCode,startIndex,maxItems);
