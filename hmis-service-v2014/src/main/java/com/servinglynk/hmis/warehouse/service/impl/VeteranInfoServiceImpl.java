...
public class VeteranInfoServiceImpl extends ServiceBase implements VeteranInfoService  {
   ...
   public VeteranInfo createVeteranInfo(VeteranInfo veteranInfo,UUID clientId,String caller){
       ...
       com.servinglynk.hmis.warehouse.model.v2014.VeteranInfo pVeteranInfo = VeteranInfoConverter.modelToEntity(veteranInfo, null);
  ...
  //     pVeteranInfo.setUser(daoFactory.getHmisUserDao().findByUsername(caller));
   ...
   public VeteranInfo updateVeteranInfo(VeteranInfo veteranInfo,UUID clientId,String caller){
       ...
       com.servinglynk.hmis.warehouse.model.v2014.VeteranInfo pVeteranInfo = daoFactory.getVeteranInfoDao().getVeteranInfoById(veteranInfo.getVeteranInfoId());
...
//       pVeteranInfo.setUser(daoFactory.getHmisUserDao().findByUsername(caller));
   ...
   public VeteranInfo deleteVeteranInfo(UUID veteranInfoId,String caller){
       com.servinglynk.hmis.warehouse.model.v2014.VeteranInfo pVeteranInfo = daoFactory.getVeteranInfoDao().getVeteranInfoById(veteranInfoId);
       if(pVeteranInfo==null) throw new VeteranInfoNotFoundException();
   ...
   public VeteranInfos getAllClientVeteranInfos(UUID clientId,Integer startIndex, Integer maxItems){
       VeteranInfos veteranInfos = new VeteranInfos();
        List<com.servinglynk.hmis.warehouse.model.v2014.VeteranInfo> entities = daoFactory.getVeteranInfoDao().getAllClientVeteranInfos(clientId,startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.v2014.VeteranInfo entity : entities){
