...
public class TestVeteranInfoAPIMethods {
    ...
    @Test
    public void TestVeteranInfoAPIMethods_1_create_VeteranInfo_testcase() throws Exception {
       Account account = createAccount();
       ...
       VeteranInfo veteranInfo = TestData.getVeteranInfo();

       veteranInfo= executor.executePost("/clients/"+clientId+"/veteraninfos",veteranInfo,VeteranInfo.class);
       Assert.assertNotNull(veteranInfo.getVeteranInfoId()); 
   }

    @Test
    public void TestVeteranInfoAPIMethods_2_update_VeteranInfo_testcase() throws Exception {
       Account account = createAccount();
       String[] methods = {"CLIENT_API_CREATE_VETERANINFO","CLIENT_API_UPDATE_VETERANINFO","CLIENT_API_DELETE_VETERANINFO","CLIENT_API_GET_VETERANINFO_BY_ID","CLIENT_API_GET_ALL_CLIENT_VETERANINFOS"};
       addingMethodAccessUsingPermissionSet(methods, account.getUsername());
       Session session = createSession(account.getUsername(),account.getPassword());
       ...
       veteranInfo= executor.executePut("/clients/"+clientId+"/veteraninfos/"+veteranInfo.getVeteranInfoId(),veteranInfo,VeteranInfo.class);
   }

    @Test
    public void TestVeteranInfoAPIMethods_3_delete_VeteranInfo_testcase() throws Exception {
       Account account = createAccount();
       String[] methods = {"CLIENT_API_CREATE_VETERANINFO","CLIENT_API_UPDATE_VETERANINFO","CLIENT_API_DELETE_VETERANINFO","CLIENT_API_GET_VETERANINFO_BY_ID","CLIENT_API_GET_ALL_CLIENT_VETERANINFOS"};
       addingMethodAccessUsingPermissionSet(methods, account.getUsername());
       Session session = createSession(account.getUsername(),account.getPassword());
       ...
       veteranInfo= executor.executeDelete("/clients/"+clientId+"/veteraninfos/"+veteranInfo.getVeteranInfoId(),veteranInfo,VeteranInfo.class);
       Assert.assertNull(veteranInfo.getVeteranInfoId()); 
   }

    @Test
    public void TestVeteranInfoAPIMethods_4_getById_VeteranInfo_testcase() throws Exception {
       Account account = createAccount();
       String[] methods = {"CLIENT_API_CREATE_VETERANINFO","CLIENT_API_UPDATE_VETERANINFO","CLIENT_API_DELETE_VETERANINFO","CLIENT_API_GET_VETERANINFO_BY_ID","CLIENT_API_GET_ALL_CLIENT_VETERANINFOS"};
       addingMethodAccessUsingPermissionSet(methods, account.getUsername());
       Session session = createSession(account.getUsername(),account.getPassword());
       ...
       VeteranInfo newveteranInfo = executor.executeGet("/clients/"+clientId+"/veteraninfos/"+veteranInfo.getVeteranInfoId(),VeteranInfo.class);
       Assert.assertEquals(veteranInfo.getVeteranInfoId(),newveteranInfo.getVeteranInfoId()); 
   }

    @Test
    public void TestVeteranInfoAPIMethods_5_getAllEnrollment_VeteranInfo_testcase() throws Exception {
       Account account = createAccount();
       String[] methods = {"CLIENT_API_CREATE_VETERANINFO","CLIENT_API_UPDATE_VETERANINFO","CLIENT_API_DELETE_VETERANINFO","CLIENT_API_GET_VETERANINFO_BY_ID","CLIENT_API_GET_ALL_CLIENT_VETERANINFOS"};
       addingMethodAccessUsingPermissionSet(methods, account.getUsername());
       Session session = createSession(account.getUsername(),account.getPassword());
       ...
       VeteranInfos veteranInfos = executor.executeGet("/clients/"+clientId+"/veteraninfos",VeteranInfos.class);
       Assert.assertEquals(veteranInfos.getVeteranInfos().size(),1); 
       // creating another record     
       veteranInfo = TestData.getVeteranInfo();

       veteranInfo= executor.executePost("/clients/"+clientId+"/veteraninfos",veteranInfo,VeteranInfo.class);
       Assert.assertNotNull(veteranInfo.getVeteranInfoId()); 

       veteranInfos = executor.executeGet("/clients/"+clientId+"/veteraninfos",VeteranInfos.class);
       System.out.println(veteranInfos.toJSONString());
       Assert.assertEquals(veteranInfos.getVeteranInfos().size(),2); 
   }

    @Test
    public void TestVeteranInfoAPIMethods_6_create_VeteranInfo_with_unknownClinet() throws Exception {
       Account account = createAccount();
       String[] methods = {"CLIENT_API_CREATE_VETERANINFO","CLIENT_API_UPDATE_VETERANINFO","CLIENT_API_DELETE_VETERANINFO","CLIENT_API_GET_VETERANINFO_BY_ID","CLIENT_API_GET_ALL_CLIENT_VETERANINFOS"};
       addingMethodAccessUsingPermissionSet(methods, account.getUsername());
       Session session = createSession(account.getUsername(),account.getPassword());
       ...
       Errors errors = executor.executePost("/clients/"+clientId+"/veteraninfos",veteranInfo, Errors.class);
       Assert.assertNotNull(errors);
       Assert.assertEquals(errors.getError().get(0).getCode(),"CLIENT_NOT_FOUND"); 
   }

    @Test
    public void TestVeteranInfoAPIMethods_7_update_VeteranInfo_with_unknownClinet() throws Exception {
       Account account = createAccount();
       String[] methods = {"CLIENT_API_CREATE_VETERANINFO","CLIENT_API_UPDATE_VETERANINFO","CLIENT_API_DELETE_VETERANINFO","CLIENT_API_GET_VETERANINFO_BY_ID","CLIENT_API_GET_ALL_CLIENT_VETERANINFOS"};
       addingMethodAccessUsingPermissionSet(methods, account.getUsername());
       Session session = createSession(account.getUsername(),account.getPassword());
       ...
       clientId = UUID.randomUUID();
       // set new values for update the data
       Errors errors = executor.executePut("/clients/"+clientId+"/veteraninfos/"+veteranInfo.getVeteranInfoId(),veteranInfo, Errors.class);
       Assert.assertNotNull(errors);
       Assert.assertEquals(errors.getError().get(0).getCode(),"CLIENT_NOT_FOUND"); 
   }

    @Test
    public void TestVeteranInfoAPIMethods_8_delete_VeteranInfo_with_unknownClinet() throws Exception {
       Account account = createAccount();
       String[] methods = {"CLIENT_API_CREATE_VETERANINFO","CLIENT_API_UPDATE_VETERANINFO","CLIENT_API_DELETE_VETERANINFO","CLIENT_API_GET_VETERANINFO_BY_ID","CLIENT_API_GET_ALL_CLIENT_VETERANINFOS"};
       addingMethodAccessUsingPermissionSet(methods, account.getUsername());
       Session session = createSession(account.getUsername(),account.getPassword());
       ...
       clientId = UUID.randomUUID();
       Errors errors = executor.executeDelete("/clients/"+clientId+"/veteraninfos/"+veteranInfo.getVeteranInfoId(),veteranInfo,Errors.class);
       Assert.assertNotNull(errors);
       Assert.assertEquals(errors.getError().get(0).getCode(),"CLIENT_NOT_FOUND"); 
   }

    @Test
    public void TestVeteranInfoAPIMethods_9_getById_VeteranInfo_with_unknownClinet() throws Exception {
       Account account = createAccount();
       String[] methods = {"CLIENT_API_CREATE_VETERANINFO","CLIENT_API_UPDATE_VETERANINFO","CLIENT_API_DELETE_VETERANINFO","CLIENT_API_GET_VETERANINFO_BY_ID","CLIENT_API_GET_ALL_CLIENT_VETERANINFOS"};
       addingMethodAccessUsingPermissionSet(methods, account.getUsername());
       Session session = createSession(account.getUsername(),account.getPassword());
       ...
       clientId = UUID.randomUUID();
       Errors errors = executor.executeGet("/clients/"+clientId+"/veteraninfos/"+veteranInfo.getVeteranInfoId(),Errors.class);
       Assert.assertNotNull(errors);
       Assert.assertEquals(errors.getError().get(0).getCode(),"CLIENT_NOT_FOUND"); 
   }

    @Test
    public void TestVeteranInfoAPIMethods_10_getAllEnrollment_VeteranInfo_with_unknowClient() throws Exception {
       Account account = createAccount();
       String[] methods = {"CLIENT_API_CREATE_VETERANINFO","CLIENT_API_UPDATE_VETERANINFO","CLIENT_API_DELETE_VETERANINFO","CLIENT_API_GET_VETERANINFO_BY_ID","CLIENT_API_GET_ALL_CLIENT_VETERANINFOS"};
       addingMethodAccessUsingPermissionSet(methods, account.getUsername());
       Session session = createSession(account.getUsername(),account.getPassword());
       ...
       clientId = UUID.randomUUID();
       Errors errors = executor.executeGet("/clients/"+clientId+"/veteraninfos",Errors.class);
       Assert.assertNotNull(errors);
       Assert.assertEquals(errors.getError().get(0).getCode(),"CLIENT_NOT_FOUND"); 
   }
