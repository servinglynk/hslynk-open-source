...
public class BasicTestMethods {
	...
	public BasicTestMethods(WebApplicationContext wac, ParentServiceFactory serviceFactory) {
		super();
		this.wac = wac;
	...
	public UUID createClient() throws Exception{
	       ...
	       client = serviceFactory.getClientService().createClient(client,Constants.AUDIT_USER_UNIT_TEST);
	...
	public UUID createOrganization() throws Exception {
		 ...
		 organization =serviceFactory.getOrganizationService().createOrganization(organization, "superadmin@hmis.com");
