...
public class TestEmploymentAPIMethods {
    ...
    @Autowired ParentServiceFactory serviceFactory;
      ...
      String[] methods = {"CLIENT_API_CREATE_EMPLOYMENT","CLIENT_API_UPDATE_EMPLOYMENT","CLIENT_API_DELETE_EMPLOYMENT","CLIENT_API_GET_EMPLOYMENT_BY_ID","CLIENT_API_GET_ALL_ENROLLMENT_EMPLOYMENT" };
    ...
    public void TestEmploymentAPIMethods_2_update_Employment_testcase() throws Exception {
       ...
       MockHttpServletResponse response = (MockHttpServletResponse)  executor.executePut("/clients/"+clientId+"/enrollments/"+enrollmentId+"/employments/"+employment.getEmploymentId(),employment);
    ...
    public void TestEmploymentAPIMethods_3_delete_Employment_testcase() throws Exception {
       ...
       MockHttpServletResponse response = (MockHttpServletResponse)  executor.executeDelete("/clients/"+clientId+"/enrollments/"+enrollmentId+"/employments/"+employment.getEmploymentId(),employment);
