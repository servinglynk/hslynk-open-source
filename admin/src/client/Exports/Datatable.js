...
import { getExports } from '../../config/actions/Exports'
...
const Index = (props) => {
	...
	const getData= (startIndex,pageSize) =>{
        ...
        props.getExports('/exports',{},params,'get').then((response)=>{
        	setSpinner(false);
        });
	}
...
export default connect(mapStateToProps,{getExports})(withRouter(Index));
