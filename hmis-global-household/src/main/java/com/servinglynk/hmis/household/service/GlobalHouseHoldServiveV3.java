...
public class GlobalHouseHoldServiveV3 {
	...
	public GlobalHouseholdModel save(GlobalHouseholdModel globalHouseholdModel) {
		 ...
		 GlobalHousehold globalHousehold = globalHouseholdRepository.findByDedupClientIdAndProjectGroupCodeAndDeleted(globalHouseholdModel.getHeadOfHouseholdId(), projectGroup, false);
