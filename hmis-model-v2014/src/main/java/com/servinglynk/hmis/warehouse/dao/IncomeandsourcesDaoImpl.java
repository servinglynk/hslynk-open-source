...
public class IncomeandsourcesDaoImpl extends ParentDaoImpl implements
	...
	public void hydrateStaging(ExportDomain domain , Map<String,HmisBaseModel> exportModelMap, Map<String,HmisBaseModel> relatedModelMap) throws Exception {
		...
		if (CollectionUtils.isNotEmpty(incomeAndSourceses)) {
			for(IncomeAndSources incomeAndSource : incomeAndSourceses) {
				processData(incomeAndSource, domain, data, modelMap, relatedModelMap, exportEntity);
			}
		}
	...
	@Transactional
	  public void processData(IncomeAndSources incomeAndSources,ExportDomain domain,Data data,Map<String,HmisBaseModel> modelMap,Map<String,HmisBaseModel> relatedModelMap,com.servinglynk.hmis.warehouse.model.v2014.Export exportEntity) {
		...
		public com.servinglynk.hmis.warehouse.model.v2014.Incomeandsources getModelObject(ExportDomain domain,IncomeAndSources incomeAndSources ,Data data, Map<String,HmisBaseModel> modelMap) {
			com.servinglynk.hmis.warehouse.model.v2014.Incomeandsources modelFromDB = null;
			// We always insert for a Full refresh and update if the record exists for Delta refresh
			if(!isFullRefresh(domain))
				modelFromDB = (com.servinglynk.hmis.warehouse.model.v2014.Incomeandsources) getModel(Incomeandsources.class.getSimpleName(),com.servinglynk.hmis.warehouse.model.v2014.Incomeandsources.class, incomeAndSources.getIncomeAndSourcesID(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
			
			if(modelFromDB == null) {
				modelFromDB = new com.servinglynk.hmis.warehouse.model.v2014.Incomeandsources();
				modelFromDB.setId(UUID.randomUUID());
				modelFromDB.setRecordToBeInserted(true);
				
			}
			 com.servinglynk.hmis.warehouse.model.v2014.Incomeandsources model = new com.servinglynk.hmis.warehouse.model.v2014.Incomeandsources();
	   ...
	   public com.servinglynk.hmis.warehouse.model.v2014.Incomeandsources getIncomeAndSourceById(UUID incomeAndSourceId){ 
		      ...
		      List<com.servinglynk.hmis.warehouse.model.v2014.Incomeandsources> entities = (List<com.servinglynk.hmis.warehouse.model.v2014.Incomeandsources>) findByCriteria(criteria);
