...
public class HealthinsuranceDaoImpl extends ParentDaoImpl implements
	...
	public com.servinglynk.hmis.warehouse.model.v2014.Healthinsurance getModelObject(ExportDomain domain,HealthInsurance healthInsurance ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2014.Healthinsurance modelFromDB = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			modelFromDB = (com.servinglynk.hmis.warehouse.model.v2014.Healthinsurance) getModel(Healthinsurance.class.getSimpleName(),com.servinglynk.hmis.warehouse.model.v2014.Healthinsurance.class, healthInsurance.getHealthInsuranceID(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
		
		if(modelFromDB == null) {
			modelFromDB = new com.servinglynk.hmis.warehouse.model.v2014.Healthinsurance();
			modelFromDB.setId(UUID.randomUUID());
			modelFromDB.setRecordToBeInserted(true);
			
		}
		 com.servinglynk.hmis.warehouse.model.v2014.Healthinsurance model = new com.servinglynk.hmis.warehouse.model.v2014.Healthinsurance();
	   ...
	   public com.servinglynk.hmis.warehouse.model.v2014.Healthinsurance getHealthInsuranceById(UUID healthInsuranceId){ 
		      ...
		      List<com.servinglynk.hmis.warehouse.model.v2014.Healthinsurance> entities = (List<com.servinglynk.hmis.warehouse.model.v2014.Healthinsurance>) findByCriteria(criteria);
