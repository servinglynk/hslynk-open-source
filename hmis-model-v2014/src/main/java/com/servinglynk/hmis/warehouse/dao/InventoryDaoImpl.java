...
public class InventoryDaoImpl extends ParentDaoImpl implements InventoryDao {
	...
	public void hydrateStaging(ExportDomain domain , Map<String,HmisBaseModel> exportModelMap, Map<String,HmisBaseModel> relatedModelMap) throws Exception {
		...
		if(inventories != null && !inventories.isEmpty())
		{
			...
			{
				try {
					com.servinglynk.hmis.warehouse.model.v2014.Inventory inventoryModel = getModelObject(domain, inventory,data,modelMap);
	...
	public com.servinglynk.hmis.warehouse.model.v2014.Inventory getModelObject(ExportDomain domain,Inventory inventory ,Data data, Map<String,HmisBaseModel> modelMap) {
		...
		if(!isFullRefresh(domain))
			inventoryModel = (com.servinglynk.hmis.warehouse.model.v2014.Inventory) getModel(com.servinglynk.hmis.warehouse.model.v2014.Inventory.class, inventory.getInventoryID(), getProjectGroupCode(domain),false,modelMap);
