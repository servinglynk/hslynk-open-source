...
public class HealthStatusDaoImpl extends ParentDaoImpl implements
	...
	public void processData(HealthStatus healthStatus,ExportDomain domain,Data data,Map<String,HmisBaseModel> modelMap,Map<String,HmisBaseModel> relatedModelMap,com.servinglynk.hmis.warehouse.model.v2014.Export exportEntity) {
