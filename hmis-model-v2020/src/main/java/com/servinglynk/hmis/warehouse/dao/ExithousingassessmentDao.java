...
public interface ExithousingassessmentDao extends ParentDao {
	...
	void hydrateLive(com.servinglynk.hmis.warehouse.model.v2020.Exithousingassessment exithousingassessment);
	
	   List<com.servinglynk.hmis.warehouse.model.v2020.Exithousingassessment> getAllExitExithousingassessments(UUID exitId,Integer startIndex, Integer maxItems);
