...
public class EntryrhspDaoImpl extends ParentDaoImpl implements EntryrhspDao{
	...
	public void hydrateStaging(ExportDomain domain , Map<String,HmisBaseModel> exportModelMap, Map<String,HmisBaseModel> relatedModelMap) throws Exception {
		...
		Data data =new Data();
		Map<String,HmisBaseModel> modelMap = getModelMap(com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp.class, getProjectGroupCode(domain));
		...
		hydrateBulkUploadActivityStaging(data.i,data.j,data.ignore, com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp.class.getSimpleName(), domain,exportEntity);
	}

	@Override
	public void hydrateLive(com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp entryRshp) {
			if(entryRshp !=null) {
				com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp target = new com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp();
				BeanUtils.copyProperties(entryRshp, target, new String[] {"enrollments","veteranInfoes"});
				com.servinglynk.hmis.warehouse.model.v2020.Export exportEntity = (com.servinglynk.hmis.warehouse.model.v2020.Export) get(com.servinglynk.hmis.warehouse.model.v2020.Export.class, entryRshp.getExport().getId());
				exportEntity.addEntryrhsp(target);
				target.setExport(exportEntity);
				com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp entryRhspByDedupCliendId = getEntryrhspByDedupEntryrhspId(entryRshp.getId(),entryRshp.getProjectGroupCode());
	...
	public com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp getModelObject(ExportDomain domain, EntryRHSP entryrhsp ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp modelFromDB = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			modelFromDB = (com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp) getModel(com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp.class, entryrhsp.getEntryRHSPID(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
...
data.i++;
	...
	@Override
	public com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp createEntryrhsp(com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp entryRhsp) {
	...
	@Override
	public Entryrhsp updateEntryrhsp(com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp entryRhsp) {
			update(entryRhsp);
		return entryRhsp;
	}
	...
	@Override
	public void deleteEntryrhsp(com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp entryRhsp) {
			delete(entryRhsp);
	...
	@Override
	public com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp getEntryrhspById(UUID entryrhspId) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp.class);
		criteria.add(Restrictions.eq("id", entryrhspId));
		List<com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp> entryrhsp = (List<com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp>) findByCriteria(criteria);
		if(entryrhsp.size()>0) return entryrhsp.get(0);
		return null;
	}
	@SuppressWarnings("unchecked")
	@Override
	public com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp getEntryrhspByDedupEntryrhspId(UUID id,String projectGroupCode) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp.class);
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp> getAllEntryrhsp(Integer startIndex, Integer maxItems) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp.class);	
		List<com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp> entryrhsp = (List<com.servinglynk.hmis.warehouse.model.v2020.Entryrhsp>) findByCriteria(criteria,startIndex,maxItems);
		return entryrhsp;
	}
