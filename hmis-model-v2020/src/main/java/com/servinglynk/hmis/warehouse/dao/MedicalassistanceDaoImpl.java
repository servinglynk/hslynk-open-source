...
public class MedicalassistanceDaoImpl extends ParentDaoImpl implements
	...
	public void hydrateStaging(ExportDomain domain , Map<String,HmisBaseModel> exportModelMap, Map<String,HmisBaseModel> relatedModelMap) throws Exception {
		...
		Data data =new Data();
		Map<String,HmisBaseModel> modelMap = getModelMap(com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance.class, getProjectGroupCode(domain));
		if(medicalAssistanceList !=null && !medicalAssistanceList.isEmpty())
		{
			for(MedicalAssistance medicalAssistance : medicalAssistanceList)
			{
				...
				try {
					...
					performSaveOrUpdate(medicalassistanceModel,domain);
				}catch(Exception e){
		...
		hydrateBulkUploadActivityStaging(data.i,data.j,data.ignore, com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance.class.getSimpleName(), domain,exportEntity);
	}
	
	public com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance getModelObject(ExportDomain domain, MedicalAssistance medicalassistance ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance modelFromDB = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			modelFromDB = (com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance) getModel(com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance.class, medicalassistance.getMedicalAssistanceID(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
	...
	public void hydrateHBASE(SyncDomain syncDomain) {
	   ...
	   public com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance createMedicalassistance(com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance medicalassistance){
	       medicalassistance.setId(UUID.randomUUID());
	       insert(medicalassistance);
	       return medicalassistance;
	   }
	   public com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance updateMedicalassistance(com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance medicalassistance){
	       update(medicalassistance);
	       return medicalassistance;
	   }
	   public void deleteMedicalassistance(com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance medicalassistance){
	       delete(medicalassistance);
	   }
	   public com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance getMedicalassistanceById(UUID medicalassistanceId){
		      DetachedCriteria criteria=DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance.class);
		      criteria.add(Restrictions.eq("id", medicalassistanceId));
		      List<com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance> entities = (List<com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance>) findByCriteria(criteria);
		      if(!entities.isEmpty()) return entities.get(0);
		      return null;
	   }
	   public List<com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance> getAllEnrollmentMedicalassistances(UUID enrollmentId,Integer startIndex, Integer maxItems){
	       DetachedCriteria criteria=DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance.class);
	       criteria.createAlias("enrollmentid", "enrollmentid");
	       criteria.add(Restrictions.eq("enrollmentid.id", enrollmentId));
	       return (List<com.servinglynk.hmis.warehouse.model.v2020.Medicalassistance>) findByCriteria(criteria,startIndex,maxItems);
	   }
