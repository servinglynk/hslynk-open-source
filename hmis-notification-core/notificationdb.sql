...
DROP SEQUENCE IF EXISTS notificationdb.hmis_notification_header_id_seq;
DROP SEQUENCE IF EXISTS notificationdb.hmis_notification_line_id_seq;
DROP SEQUENCE IF EXISTS notificationdb.hmis_notification_param_seq;
DROP SEQUENCE IF EXISTS notificationdb.hmis_template_header_id_seq;
DROP SEQUENCE IF EXISTS notificationdb.hmis_template_line_id_seq;
DROP SEQUENCE IF EXISTS notificationdb.hmis_worker_header_id_seq;
DROP SEQUENCE IF EXISTS notificationdb.hmis_worker_line_id_seq;

CREATE SEQUENCE notificationdb.hmis_notification_header_id_seq;
CREATE SEQUENCE notificationdb.hmis_notification_line_id_seq;
CREATE SEQUENCE notificationdb.hmis_notification_param_seq;
CREATE SEQUENCE notificationdb.hmis_template_header_id_seq;
CREATE SEQUENCE notificationdb.hmis_template_line_id_seq;
CREATE SEQUENCE notificationdb.hmis_worker_header_id_seq;
CREATE SEQUENCE notificationdb.hmis_worker_line_id_seq;
...
INSERT INTO "notificationdb".hmis_notification_param (id, sender_email_address, sender_friendly_name, external_id, insert_at, insert_by, update_at, update_by, template_id) VALUES (9, 'hmisprojects@gmail.com', 'HMIS_ACCOUNT_TWO_FACTOR_AUTH_ENABLED', 'HMIS_ACCOUNT_TWO_FACTOR_AUTH_ENABLED', NULL, NULL, NULL, NULL, 'HMIS_ACCOUNT_TWO_FACTOR_AUTH_ENABLED');
...
INSERT INTO "notificationdb".hmis_template_header (id, friendly_name, external_id, insert_by, update_by, update_at, insert_at) VALUES (9, 'HMIS_ACCOUNT_TWO_FACTOR_AUTH_ENABLED', 'HMIS_ACCOUNT_TWO_FACTOR_AUTH_ENABLED', NULL, NULL, NULL, NULL);

INSERT INTO "notificationdb".hmis_template_line (id, template_header_id, version, body_location, insert_by, update_by, update_at, insert_at, external_id, subject) VALUES (1, 1, '1', 'vt.developerCompanyCreation.vm', NULL, NULL, NULL, NULL, 'HMIS_DEVELOPER_COMPANY_CREATION', 'New Developer Company Created.');
INSERT INTO "notificationdb".hmis_template_line (id, template_header_id, version, body_location, insert_by, update_by, update_at, insert_at, external_id, subject) VALUES (2, 2, '1', 'vt.trustedAppCreation.vm', NULL, NULL, NULL, NULL, 'HMIS_TRUSTEDAPP_CREATION', 'New Trusted App Created.');
INSERT INTO "notificationdb".hmis_template_line (id, template_header_id, version, body_location, insert_by, update_by, update_at, insert_at, external_id, subject) VALUES (3, 3, '1', 'vt.developerServiceCreation.vm', NULL, NULL, NULL, NULL, 'HMIS_DEVELOPER_SERVICE_CREATION', 'New Developer Service Created.');
...
INSERT INTO "notificationdb".hmis_template_line (id, template_header_id, version, body_location, insert_by, update_by, update_at, insert_at, external_id, subject) VALUES (8, 8, '1', 'vt.trustedApp_status_update.vm', NULL, NULL, NULL, NULL, 'TRUSTEDAPP_STATUS_UPDATE', 'TrustedApp Status Updation');
INSERT INTO "notificationdb".hmis_template_line (id, template_header_id, version, body_location, insert_by, update_by, update_at, insert_at, external_id, subject) VALUES (9, 9, '1', 'vt.hmis_resource_two_factor_enabled.vm', NULL, NULL, NULL, NULL, 'HMIS_ACCOUNT_TWO_FACTOR_AUTH_ENABLED', 'Two Factor Authentication enabled for your account');
