...
public class EntryssvfDaoImpl extends ParentDaoImpl implements EntryssvfDao{
	...
	public void hydrateStaging(ExportDomain domain , Map<String,HmisBaseModel> exportModelMap, Map<String,HmisBaseModel> relatedModelMap) throws Exception {
		...
		Data data =new Data();
		Map<String,HmisBaseModel> modelMap = getModelMap(com.servinglynk.hmis.warehouse.model.v2016.Entryssvf.class, getProjectGroupCode(domain));
		List<EntrySSVF> entrySSVFs = export.getEntrySSVF();
		if (entrySSVFs != null && entrySSVFs.size() > 0) {
			for (EntrySSVF entrySSVF : entrySSVFs) {
				com.servinglynk.hmis.warehouse.model.v2016.Entryssvf entrySsvfModel = null;
				try {
		...
		hydrateBulkUploadActivityStaging(data.i,data.j,data.ignore, com.servinglynk.hmis.warehouse.model.v2016.Entryssvf.class.getSimpleName(), domain,exportEntity);
	}

	public com.servinglynk.hmis.warehouse.model.v2016.Entryssvf getModelObject(ExportDomain domain, EntrySSVF entryssvf ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2016.Entryssvf modelFromDB = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			modelFromDB = (com.servinglynk.hmis.warehouse.model.v2016.Entryssvf) getModel(com.servinglynk.hmis.warehouse.model.v2016.Entryssvf.class, entryssvf.getEntrySSVFID(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
		
		if(modelFromDB == null) {
			modelFromDB = new com.servinglynk.hmis.warehouse.model.v2016.Entryssvf();
	...
	@Override
	public void hydrateLive(com.servinglynk.hmis.warehouse.model.v2016.Entryssvf entrySsvf) {
			if(entrySsvf !=null) {
				com.servinglynk.hmis.warehouse.model.v2016.Entryssvf target = new com.servinglynk.hmis.warehouse.model.v2016.Entryssvf();
				BeanUtils.copyProperties(entrySsvf, target, new String[] {"enrollments","veteranInfoes"});
				com.servinglynk.hmis.warehouse.model.v2016.Export exportEntity = (com.servinglynk.hmis.warehouse.model.v2016.Export) get(com.servinglynk.hmis.warehouse.model.v2016.Export.class, entrySsvf.getExport().getId());
				exportEntity.addEntryssvf(target);
				target.setExport(exportEntity);
				com.servinglynk.hmis.warehouse.model.v2016.Entryssvf entryssvfByDedupCliendId = getEntryssvfByDedupEntryssvfId(entrySsvf.getId(),entrySsvf.getProjectGroupCode());
	...
	@Override
	public Entryssvf updateEntryssvf(com.servinglynk.hmis.warehouse.model.v2016.Entryssvf entryssvf) {
			update(entryssvf);
		return entryssvf;
	}
	...
	@Override
	public void deleteEntryssvf(com.servinglynk.hmis.warehouse.model.v2016.Entryssvf entryssvf) {
			delete(entryssvf);
	...
	@Override
	public com.servinglynk.hmis.warehouse.model.v2016.Entryssvf getEntryssvfById(UUID entrySsvfId) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Entryssvf.class);
		criteria.add(Restrictions.eq("id", entrySsvfId));
		List<com.servinglynk.hmis.warehouse.model.v2016.Entryssvf> entrySsvf = (List<com.servinglynk.hmis.warehouse.model.v2016.Entryssvf>) findByCriteria(criteria);
		if(entrySsvf.size()>0) return entrySsvf.get(0);
		return null;
	}
	@SuppressWarnings("unchecked")
	@Override
	public com.servinglynk.hmis.warehouse.model.v2016.Entryssvf getEntryssvfByDedupEntryssvfId(UUID id,String projectGroupCode) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Entryssvf.class);
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<com.servinglynk.hmis.warehouse.model.v2016.Entryssvf> getAllEntryssvf(Integer startIndex, Integer maxItems) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Entryssvf.class);	
		List<com.servinglynk.hmis.warehouse.model.v2016.Entryssvf> entryssvf = (List<com.servinglynk.hmis.warehouse.model.v2016.Entryssvf>) findByCriteria(criteria,startIndex,maxItems);
		return entryssvf;
	}
	...
	public List<com.servinglynk.hmis.warehouse.model.v2016.Entryssvf> getAllEnrollmentEntryssvfs(UUID enrollmentId, Integer startIndex, Integer maxItems) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Entryssvf.class);	
