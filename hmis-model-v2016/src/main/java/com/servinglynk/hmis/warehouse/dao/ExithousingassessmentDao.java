...
public interface ExithousingassessmentDao extends ParentDao {
	...
	void hydrateLive(com.servinglynk.hmis.warehouse.model.v2016.Exithousingassessment exithousingassessment);
	
	   List<com.servinglynk.hmis.warehouse.model.v2016.Exithousingassessment> getAllExitExithousingassessments(UUID exitId,Integer startIndex, Integer maxItems);
