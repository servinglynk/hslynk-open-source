...
public class CocDaoImpl  extends ParentDaoImpl implements CocDao{
	...
	public void hydrateStaging(ExportDomain domain , Map<String,HmisBaseModel> exportModelMap, Map<String,HmisBaseModel> relatedModelMap) throws Exception {
		...
		Data data =new Data();
		Map<String,HmisBaseModel> modelMap = getModelMap(com.servinglynk.hmis.warehouse.model.v2016.Coc.class, getProjectGroupCode(domain));
		List<CoC> cocs = export.getCoC();
		if (cocs != null && cocs.size() > 0) {
			for (CoC coc : cocs) {
				com.servinglynk.hmis.warehouse.model.v2016.Coc cocModel = null;
				try {
		...
		hydrateBulkUploadActivityStaging(data.i,data.j,data.ignore, com.servinglynk.hmis.warehouse.model.v2016.Coc.class.getSimpleName(), domain, exportEntity);
	
	}
	
	public  com.servinglynk.hmis.warehouse.model.v2016.Coc getModelObject(ExportDomain domain, CoC coc,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2016.Coc modelFromDB = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			modelFromDB = (com.servinglynk.hmis.warehouse.model.v2016.Coc) getModel(com.servinglynk.hmis.warehouse.model.v2016.Coc.class, coc.getCoCCode(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
		
		if(modelFromDB == null) {
			modelFromDB = new com.servinglynk.hmis.warehouse.model.v2016.Coc();
			modelFromDB.setId(UUID.randomUUID());
			modelFromDB.setRecordToBeInserted(true);
		}
		com.servinglynk.hmis.warehouse.model.v2016.Coc model = new com.servinglynk.hmis.warehouse.model.v2016.Coc();
	...
	public void hydrateLive(
			com.servinglynk.hmis.warehouse.model.v2016.Coc coc) {
			if(coc !=null) {
				com.servinglynk.hmis.warehouse.model.v2016.Coc target = new com.servinglynk.hmis.warehouse.model.v2016.Coc();
				BeanUtils.copyProperties(coc, target, new String[] {"enrollments","veteranInfoes"});
				com.servinglynk.hmis.warehouse.model.v2016.Export exportEntity = (com.servinglynk.hmis.warehouse.model.v2016.Export) get(com.servinglynk.hmis.warehouse.model.v2016.Export.class, coc.getExport().getId());
				exportEntity.addCoc(target);
				target.setExport(exportEntity);
				com.servinglynk.hmis.warehouse.model.v2016.Coc clientByDedupCliendId = getCocByDedupCliendId(coc.getId(),coc.getProjectGroupCode());
	...
	public void hydrateHBASE(SyncDomain syncDomain) {
	   ...
	   public com.servinglynk.hmis.warehouse.model.v2016.Project getProjectById(UUID projectId){ 
	       return (com.servinglynk.hmis.warehouse.model.v2016.Project) get(com.servinglynk.hmis.warehouse.model.v2016.Project.class, projectId);
	   }
	   public List<com.servinglynk.hmis.warehouse.model.v2016.Project> getAllProjects(Integer startIndex, Integer maxItems){
	...
	@Override
	public com.servinglynk.hmis.warehouse.model.v2016.Coc createCoc(
			com.servinglynk.hmis.warehouse.model.v2016.Coc coc) {
	...
	@Override
	public com.servinglynk.hmis.warehouse.model.v2016.Coc updateCoc(
			com.servinglynk.hmis.warehouse.model.v2016.Coc coc) {
			update(coc);
		return coc;
	}
	...
	@Override
	public com.servinglynk.hmis.warehouse.model.v2016.Coc getCocById(UUID cocId) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Coc.class);
		criteria.add(Restrictions.eq("id", cocId));
		List<com.servinglynk.hmis.warehouse.model.v2016.Coc> coc = (List<com.servinglynk.hmis.warehouse.model.v2016.Coc>) findByCriteria(criteria);
		if(coc.size()>0) return coc.get(0);
		return null;
	}
	public com.servinglynk.hmis.warehouse.model.v2016.Coc getCocByDedupCliendId(UUID id,String projectGroupCode) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Coc.class);
	...
	public com.servinglynk.hmis.warehouse.model.v2016.Coc getCocByDedupCliendIdFromStaging(UUID id) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Coc.class);
		criteria.add(Restrictions.eq("dedupClientId", id));
		List<com.servinglynk.hmis.warehouse.model.v2016.Coc> coc = (List<com.servinglynk.hmis.warehouse.model.v2016.Coc>) findByCriteria(criteria);
		if(coc !=null && coc.size()>0) return coc.get(0);
	...
	public List<com.servinglynk.hmis.warehouse.model.v2016.Coc> getAllCoc(Integer startIndex, Integer maxItems) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Coc.class);	
		List<com.servinglynk.hmis.warehouse.model.v2016.Coc> coc = (List<com.servinglynk.hmis.warehouse.model.v2016.Coc>) findByCriteria(criteria,startIndex,maxItems);
		return coc;
	}
