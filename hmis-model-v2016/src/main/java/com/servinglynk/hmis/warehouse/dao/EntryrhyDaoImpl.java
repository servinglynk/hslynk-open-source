...
public class EntryrhyDaoImpl extends ParentDaoImpl implements  EntryrhyDao{
	...
	public void hydrateStaging(ExportDomain domain , Map<String,HmisBaseModel> exportModelMap, Map<String,HmisBaseModel> relatedModelMap) throws Exception {
		...
		Data data =new Data();
		Map<String,HmisBaseModel> modelMap = getModelMap(com.servinglynk.hmis.warehouse.model.v2016.Entryrhy.class, getProjectGroupCode(domain));
		List<EntryRHY> entryRhy = export.getEntryRHY();
		if (entryRhy != null && entryRhy.size() > 0) {
			for (EntryRHY entryRhys : entryRhy) {
				com.servinglynk.hmis.warehouse.model.v2016.Entryrhy entryRhyModel = null;
				try {
...
//				entryRhyModel.setVersion(version);
		...
		hydrateBulkUploadActivityStaging(data.i,data.j,data.ignore, com.servinglynk.hmis.warehouse.model.v2016.Entryrhy.class.getSimpleName(), domain,exportEntity);
	}

	public com.servinglynk.hmis.warehouse.model.v2016.Entryrhy getModelObject(ExportDomain domain, EntryRHY entryrhy ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2016.Entryrhy modelFromDB = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			modelFromDB = (com.servinglynk.hmis.warehouse.model.v2016.Entryrhy) getModel(com.servinglynk.hmis.warehouse.model.v2016.Entryrhy.class, entryrhy.getEntryRHYID(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
		
		if(modelFromDB == null) {
			modelFromDB = new com.servinglynk.hmis.warehouse.model.v2016.Entryrhy();
			modelFromDB.setId(UUID.randomUUID());
			modelFromDB.setRecordToBeInserted(true);
		}
		com.servinglynk.hmis.warehouse.model.v2016.Entryrhy model = new com.servinglynk.hmis.warehouse.model.v2016.Entryrhy();
	...
	@Override
	public void hydrateLive(com.servinglynk.hmis.warehouse.model.v2016.Entryrhy entryRhy) {
			if(entryRhy !=null) {
				com.servinglynk.hmis.warehouse.model.v2016.Entryrhy target = new com.servinglynk.hmis.warehouse.model.v2016.Entryrhy();
				BeanUtils.copyProperties(entryRhy, target, new String[] {"enrollments","veteranInfoes"});
				com.servinglynk.hmis.warehouse.model.v2016.Export exportEntity = (com.servinglynk.hmis.warehouse.model.v2016.Export) get(com.servinglynk.hmis.warehouse.model.v2016.Export.class, entryRhy.getExport().getId());
				exportEntity.addEntryrhy(target);
				target.setExport(exportEntity);
				com.servinglynk.hmis.warehouse.model.v2016.Entryrhy entryRhyByDedupCliendId = getEntryrhyByDedupEntryrhyId(entryRhy.getId(),entryRhy.getProjectGroupCode());
	...
	@Override
	public com.servinglynk.hmis.warehouse.model.v2016.Entryrhy createEntryrhy(com.servinglynk.hmis.warehouse.model.v2016.Entryrhy entryRhy) {
	...
	@Override
	public Entryrhy updateEntryrhy(com.servinglynk.hmis.warehouse.model.v2016.Entryrhy entryRhy) {
			update(entryRhy);
		return entryRhy;
	}
	...
	@Override
	public void deleteEntryrhy(com.servinglynk.hmis.warehouse.model.v2016.Entryrhy entryRhy) {
			delete(entryRhy);
	...
	@Override
	public com.servinglynk.hmis.warehouse.model.v2016.Entryrhy getEntryrhyById(UUID entryrhyId) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Entryrhy.class);
		criteria.add(Restrictions.eq("id", entryrhyId));
		List<com.servinglynk.hmis.warehouse.model.v2016.Entryrhy> entryrhy = (List<com.servinglynk.hmis.warehouse.model.v2016.Entryrhy>) findByCriteria(criteria);
		if(entryrhy.size()>0) return entryrhy.get(0);
		return null;
	}
	@SuppressWarnings("unchecked")
	@Override
	public com.servinglynk.hmis.warehouse.model.v2016.Entryrhy getEntryrhyByDedupEntryrhyId(UUID id,String projectGroupCode) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Entryrhy.class);
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<com.servinglynk.hmis.warehouse.model.v2016.Entryrhy> getAllEntryrhy(Integer startIndex, Integer maxItems) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Entryrhy.class);	
		List<com.servinglynk.hmis.warehouse.model.v2016.Entryrhy> entryrhy = (List<com.servinglynk.hmis.warehouse.model.v2016.Entryrhy>) findByCriteria(criteria,startIndex,maxItems);
		return entryrhy;
	}
