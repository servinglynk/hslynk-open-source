...
public static String HOUSING_INVENTORY_ACTIVE_LIST = "select survey_score as score, client_id, survey_date from housing_inventory.eligible_clients where project_group_code=? and deleted=false  and ignore_match_process=false order by date_created desc";
public static String GET_LASTEST_SURVEY_BY_CLIENT="select survey_id from survey.section_score where client_id=? order by created_at desc limit 1";
