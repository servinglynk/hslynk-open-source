...
public static String GET_CLIENTS_WITH_RESPONSE =	"select submission_id,client_id,question_id,response_text from survey.response where submission_id is not null and client_id is not null and survey_id=? and client_id=? group by client_id,submission_id,question_id,response_text order by client_id,submission_id";
