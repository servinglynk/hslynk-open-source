...
public class TestDisabilitiesAPIMethods {
    ...
    public void TestDisabilitiesAPIMethods_2_update_Disabilities_testcase() throws Exception {
       ...
       MockHttpServletResponse response = (MockHttpServletResponse)  executor.executePut("/clients/"+clientId+"/enrollments/"+enrollmentId+"/disabilitiess/"+disabilities.getDisabilitiesId(),disabilities);
    ...
    public void TestDisabilitiesAPIMethods_3_delete_Disabilities_testcase() throws Exception {
       ...
       MockHttpServletResponse response = (MockHttpServletResponse)  executor.executeDelete("/clients/"+clientId+"/enrollments/"+enrollmentId+"/disabilitiess/"+disabilities.getDisabilitiesId(),disabilities);
