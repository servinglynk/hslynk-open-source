...
INSERT INTO live.hmis_project_group( id, project_group_name, project_group_desc, project_group_code, created_at, created_by) values ('9b9792ca-8730-4d21-9a39-6902229fd4b9','PROJECT_GROUP_NAME','PROJECT_GROUP_DESCRIPTION','PG0001', current_date,'MASTER_DATA');
...
CREATE OR REPLACE FUNCTION admin.createDeveloperProfileACL() RETURNS SETOF admin.hmis_api_method AS
$BODY$
DECLARE
    r admin.hmis_api_method%rowtype;
BEGIN
    FOR r IN SELECT * FROM admin.hmis_api_method  WHERE api_group_id ='084ab7d7de7e-1138-4f74-b50e-d9ebbc10'
    LOOP
    RAISE NOTICE '%',r.id;
        INSERT INTO admin.hmis_profile_acl(profile_id, api_method_id, id, created_at, created_by) VALUES ('b67c38a1-2762-4393-b69b-41a0a11e6efc', r.id, (SELECT uuid_in(md5(random()::text || now()::text)::cstring)), current_timestamp, 'MASTER_DATA');
    END LOOP;
	INSERT INTO admin.hmis_profile_acl(profile_id, api_method_id, id, created_at, created_by ) VALUES ('b67c38a1-2762-4393-b69b-41a0a11e6efc','039c55be-bf44-4e22-8a79-5ba861756c45' , (SELECT uuid_in(md5(random()::text || now()::text)::cstring)), current_date, 'MASTER DATA');
	INSERT INTO admin.hmis_profile_acl(profile_id, api_method_id, id, created_at, created_by ) VALUES ('b67c38a1-2762-4393-b69b-41a0a11e6efc','3336586d-5034-41fc-a32c-9aab26873dd3' , (SELECT uuid_in(md5(random()::text || now()::text)::cstring)), current_date, 'MASTER DATA');
	INSERT INTO admin.hmis_profile_acl(profile_id, api_method_id, id, created_at, created_by ) VALUES ('b67c38a1-2762-4393-b69b-41a0a11e6efc','29d8611c-bf90-427d-b18a-1fe2473c9ffd' , (SELECT uuid_in(md5(random()::text || now()::text)::cstring)), current_date, 'MASTER DATA');
	INSERT INTO admin.hmis_profile_acl(profile_id, api_method_id, id, created_at, created_by ) VALUES ('b67c38a1-2762-4393-b69b-41a0a11e6efc','72df4ae1-3659-49cb-a221-84cee475a58e' , (SELECT uuid_in(md5(random()::text || now()::text)::cstring)), current_date, 'MASTER DATA');
	INSERT INTO admin.hmis_profile_acl(profile_id, api_method_id, id, created_at, created_by ) VALUES ('b67c38a1-2762-4393-b69b-41a0a11e6efc','b02a288d-85f2-4a5e-95d1-a43db8383e05' , (SELECT uuid_in(md5(random()::text || now()::text)::cstring)), current_date, 'MASTER DATA');
	INSERT INTO admin.hmis_profile_acl(profile_id, api_method_id, id, created_at, created_by ) VALUES ('b67c38a1-2762-4393-b69b-41a0a11e6efc','60935f25-fec5-4e4d-b0c3-452d21d1848f' , (SELECT uuid_in(md5(random()::text || now()::text)::cstring)), current_date, 'MASTER DATA');
	INSERT INTO admin.hmis_profile_acl(profile_id, api_method_id, id, created_at, created_by ) VALUES ('b67c38a1-2762-4393-b69b-41a0a11e6efc','600df1a9-b9e4-4953-b90e-8d55d67233ac' , (SELECT uuid_in(md5(random()::text || now()::text)::cstring)), current_date, 'MASTER DATA');
	INSERT INTO admin.hmis_profile_acl(profile_id, api_method_id, id, created_at, created_by ) VALUES ('b67c38a1-2762-4393-b69b-41a0a11e6efc','3336586d-5034-41fc-a32c-9aab26873dd3' , (SELECT uuid_in(md5(random()::text || now()::text)::cstring)), current_date, 'MASTER DATA');
	INSERT INTO admin.hmis_profile_acl(profile_id, api_method_id, id, created_at, created_by ) VALUES ('b67c38a1-2762-4393-b69b-41a0a11e6efc','9593ca58-78f6-4794-9d39-9412216c2f97' , (SELECT uuid_in(md5(random()::text || now()::text)::cstring)), current_date, 'MASTER DATA');
	INSERT INTO admin.hmis_profile_acl(profile_id, api_method_id, id, created_at, created_by ) VALUES ('b67c38a1-2762-4393-b69b-41a0a11e6efc','eb23bef5-423f-464f-946c-5521eda0850c' , (SELECT uuid_in(md5(random()::text || now()::text)::cstring)), current_date, 'MASTER DATA');
    RETURN;
END
$BODY$
LANGUAGE 'plpgsql' ;
