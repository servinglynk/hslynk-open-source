...
public class EnrollmentLinks {
	...
	Map<String,Map<String,List<ActionLinks>>> connectionwithsoars = new HashMap<>();
...
Map<String,Map<String,List<ActionLinks>>> serviceFaReferrals = new HashMap<>();
	...
	public Map<String, Map<String, List<ActionLinks>>> getConnectionwithsoars() {
		return connectionwithsoars;
	}
	public void setConnectionwithsoars(Map<String, Map<String, List<ActionLinks>>> connectionwithsoars) {
