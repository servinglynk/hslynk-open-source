...
import com.servinglynk.hmis.warehouse.base.service.converter.OrganizationConverter;
...
public class OrganizationServiceImpl extends ServiceBase implements OrganizationService  {
   ...
   public Organization createOrganization(Organization organization,String caller){
       com.servinglynk.hmis.warehouse.model.base.Organization pOrganization = OrganizationConverter.modelToEntity(organization, null);
   ...
   public Organization updateOrganization(Organization organization,String caller){
       com.servinglynk.hmis.warehouse.model.base.Organization pOrganization = daoFactory.getOrganizationDao().getOrganizationById(organization.getOrganizationId());
   ...
   public Organizations getAllOrganizations(Integer startIndex, Integer maxItems){
       Organizations organizations = new Organizations();
        List<com.servinglynk.hmis.warehouse.model.base.Organization> entities = daoFactory.getOrganizationDao().getAllOrganizations(startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.base.Organization entity : entities){
