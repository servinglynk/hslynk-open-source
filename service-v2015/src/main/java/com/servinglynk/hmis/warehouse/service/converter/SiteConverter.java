...
public class SiteConverter extends BaseConverter {
   ...
   public static com.servinglynk.hmis.warehouse.model.v2015.Site modelToEntity (Site model ,com.servinglynk.hmis.warehouse.model.v2015.Site entity) {
       if(entity==null) entity = new com.servinglynk.hmis.warehouse.model.v2015.Site();
   ...
   public static Site entityToModel (com.servinglynk.hmis.warehouse.model.v2015.Site entity) {
       Site model = new Site();
