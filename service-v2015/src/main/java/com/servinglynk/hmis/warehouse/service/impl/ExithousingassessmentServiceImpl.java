...
public class ExithousingassessmentServiceImpl extends ServiceBase implements ExithousingassessmentService  {
   ...
   public Exithousingassessment createExithousingassessment(Exithousingassessment exithousingassessment,UUID exitId,String caller){
       com.servinglynk.hmis.warehouse.model.v2015.Exithousingassessment pExithousingassessment = ExithousingassessmentConverter.modelToEntity(exithousingassessment, null);
   ...
   public Exithousingassessment updateExithousingassessment(Exithousingassessment exithousingassessment,UUID exitId,String caller){
       com.servinglynk.hmis.warehouse.model.v2015.Exit pExit = daoFactory.getExitDao().getExitById(exitId); 
       if(pExit == null) throw new ExitNotFoundException(); 
       com.servinglynk.hmis.warehouse.model.v2015.Exithousingassessment pExithousingassessment = daoFactory.getExithousingassessmentDao().getExithousingassessmentById(exithousingassessment.getExithousingassessmentId());
   ...
   public Exithousingassessment deleteExithousingassessment(UUID exithousingassessmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2015.Exithousingassessment pExithousingassessment = daoFactory.getExithousingassessmentDao().getExithousingassessmentById(exithousingassessmentId);
       if(pExithousingassessment==null) throw new ExithousingassessmentNotFoundException();
