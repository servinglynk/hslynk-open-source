...
public class HmisHouseHoldConverter {
	...
	public static HmisHousehold entityToModel(com.servinglynk.hmis.warehouse.model.v2015.HmisHousehold entity) {
		...
		model.addLink(new ActionLink("enrollments", "/hmis-clientapi/rest/v2015/clients/"+entity.getHeadOfHousehold().getId()+"/enrollments"));
	...
	public static HouseHoldMember entityToModel(HmisHouseHoldMember entity) {
		...
		model.addLink(new ActionLink("enrollments", "/hmis-clientapi/rest/v2015/clients/"+entity.getMember().getId()+"/enrollments"));
		return model;
	}
}
