...
public class SiteServiceImpl extends ServiceBase implements SiteService  {
   ...
   public Site createSite(Site site,UUID projectCocId,String caller){
       com.servinglynk.hmis.warehouse.model.v2015.Site pSite = SiteConverter.modelToEntity(site, null);
   ...
   public Site updateSite(Site site,UUID projectCocId,String caller){
	   com.servinglynk.hmis.warehouse.model.v2015.Coc pProjectcoc = daoFactory.getCocDao().getCocById(projectCocId);
       if(pProjectcoc == null) throw new CocNotFoundException(); 
       com.servinglynk.hmis.warehouse.model.v2015.Site pSite = daoFactory.getSiteDao().getSiteById(site.getSiteId());
   ...
   public Site deleteSite(UUID siteId,String caller){
       com.servinglynk.hmis.warehouse.model.v2015.Site pSite = daoFactory.getSiteDao().getSiteById(siteId);
       if(pSite==null) throw new SiteNotFoundException();
   ...
   public Sites getAllProjectCocSites(UUID projectCocId,Integer startIndex, Integer maxItems){
       Sites sites = new Sites();
        List<com.servinglynk.hmis.warehouse.model.v2015.Site> entities = daoFactory.getSiteDao().getAllProjectCOCSites(projectCocId,startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.v2015.Site entity : entities){
