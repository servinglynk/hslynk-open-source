...
public class ProjectcocServiceImpl extends ServiceBase implements ProjectcocService  {
   ...
   public Projectcoc createProjectcoc(Projectcoc projectcoc,UUID projectId,String caller){
       com.servinglynk.hmis.warehouse.model.v2015.Coc pCoc = CocConverter.modelToEntity(projectcoc, null);
   ...
   public Projectcoc updateProjectcoc(Projectcoc projectcoc,UUID projectId,String caller){
       com.servinglynk.hmis.warehouse.model.v2015.Project pProject = daoFactory.getProjectDao().getProjectById(projectId); 
       if(pProject == null) throw new ProjectNotFoundException(); 
       com.servinglynk.hmis.warehouse.model.v2015.Coc pCoc = daoFactory.getCocDao().getCocById(projectcoc.getProjectcocId());
   ...
   public Projectcoc deleteProjectcoc(UUID projectcocId,String caller){
       com.servinglynk.hmis.warehouse.model.v2015.Coc pCoc = daoFactory.getCocDao().getCocById(projectcocId);
       if(pCoc==null) throw new CocNotFoundException();
   ...
   public Projectcocs getAllProjectCocs(UUID projectId,Integer startIndex, Integer maxItems){
	   Projectcocs cocs = new Projectcocs();
        List<com.servinglynk.hmis.warehouse.model.v2015.Coc> entities = daoFactory.getCocDao().getAllCocs(projectId,startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.v2015.Coc entity : entities){
