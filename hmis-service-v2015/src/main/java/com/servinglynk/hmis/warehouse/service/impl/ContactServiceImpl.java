...
public class ContactServiceImpl extends ServiceBase implements ContactService  {
   ...
   public Contact createContact(Contact contact,UUID enrollmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2015.Contact pContact = ContactConverter.modelToEntity(contact, null);
   ...
   public Contact updateContact(Contact contact,UUID enrollmentId,String caller){
       com.servinglynk.hmis.warehouse.model.v2015.Enrollment pEnrollment = daoFactory.getEnrollmentDao().getEnrollmentById(enrollmentId); 
       if(pEnrollment == null) throw new EnrollmentNotFound(); 
       com.servinglynk.hmis.warehouse.model.v2015.Contact pContact = daoFactory.getContactDao().getContactById(contact.getContactId());
   ...
   public Contact deleteContact(UUID contactId,String caller){
       com.servinglynk.hmis.warehouse.model.v2015.Contact pContact = daoFactory.getContactDao().getContactById(contactId);
       if(pContact==null) throw new ContactNotFoundException();
   ...
   public Contacts getAllEnrollmentContacts(UUID enrollmentId,Integer startIndex, Integer maxItems){
       Contacts contacts = new Contacts();
        List<com.servinglynk.hmis.warehouse.model.v2015.Contact> entities = daoFactory.getContactDao().getAllEnrollmentContacts(enrollmentId,startIndex,maxItems);
        for(com.servinglynk.hmis.warehouse.model.v2015.Contact entity : entities){
