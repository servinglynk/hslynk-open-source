...
public class ExitrhyDaoImpl extends ParentDaoImpl implements ExitrhyDao {
	...
	public void hydrateStaging(ExportDomain domain , Map<String,HmisBaseModel> exportModelMap, Map<String,HmisBaseModel> relatedModelMap) throws Exception {
		...
		Data data =new Data();
		Map<String,HmisBaseModel> modelMap = getModelMap(com.servinglynk.hmis.warehouse.model.v2016.Exitrhy.class, getProjectGroupCode(domain));
		List<ExitRHY> exitrhy = export.getExitRHY();
		if (exitrhy != null && exitrhy.size() > 0) {
			for (ExitRHY exitrhys : exitrhy) {
				com.servinglynk.hmis.warehouse.model.v2016.Exitrhy exitrhyModel = null;
				try {
					...
					com.servinglynk.hmis.warehouse.model.v2016.Exit exit = (com.servinglynk.hmis.warehouse.model.v2016.Exit) getModel(com.servinglynk.hmis.warehouse.model.v2016.Exit.class,exitrhys.getExitID(),getProjectGroupCode(domain),true,relatedModelMap, domain.getUpload().getId());
		...
		hydrateBulkUploadActivityStaging(data.i,data.j,data.ignore, com.servinglynk.hmis.warehouse.model.v2016.Exitrhy.class.getSimpleName(), domain,exportEntity);
	}

	@Override
	public void hydrateLive(com.servinglynk.hmis.warehouse.model.v2016.Exitrhy exitrhy) {
			if(exitrhy !=null) {
				com.servinglynk.hmis.warehouse.model.v2016.Exitrhy target = new com.servinglynk.hmis.warehouse.model.v2016.Exitrhy();
				BeanUtils.copyProperties(exitrhy, target, new String[] {"enrollments","veteranInfoes"});
				com.servinglynk.hmis.warehouse.model.v2016.Export exportEntity = (com.servinglynk.hmis.warehouse.model.v2016.Export) get(com.servinglynk.hmis.warehouse.model.v2016.Export.class, exitrhy.getExport().getId());
				exportEntity.addExitrhy(target);
				target.setExport(exportEntity);
				com.servinglynk.hmis.warehouse.model.v2016.Exitrhy ExitrhyByDedupCliendId = getExitrhyByDedupExitrhyId(exitrhy.getId(),exitrhy.getProjectGroupCode());
	...
	public com.servinglynk.hmis.warehouse.model.v2016.Exitrhy getModelObject(ExportDomain domain, ExitRHY exitrhy ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2016.Exitrhy modelFromDB = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			modelFromDB = (com.servinglynk.hmis.warehouse.model.v2016.Exitrhy) getModel(com.servinglynk.hmis.warehouse.model.v2016.Exitrhy.class, exitrhy.getExitRHYID(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
		
		if(modelFromDB == null) {
			modelFromDB = new com.servinglynk.hmis.warehouse.model.v2016.Exitrhy();
	...
	@Override
	public Exitrhy updateExitrhy(com.servinglynk.hmis.warehouse.model.v2016.Exitrhy exitrhy) {
			update(exitrhy);
		return exitrhy;
	}
	...
	@Override
	public void deleteExitrhy(com.servinglynk.hmis.warehouse.model.v2016.Exitrhy exitrhy) {
			delete(exitrhy);
	...
	@Override
	public com.servinglynk.hmis.warehouse.model.v2016.Exitrhy getExitrhyById(UUID ExitrhyId) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Exitrhy.class);
		criteria.add(Restrictions.eq("id", ExitrhyId));
		List<com.servinglynk.hmis.warehouse.model.v2016.Exitrhy> exitrhy = (List<com.servinglynk.hmis.warehouse.model.v2016.Exitrhy>) findByCriteria(criteria);
		if(exitrhy.size()>0) return exitrhy.get(0);
		return null;
	}
	@SuppressWarnings("unchecked")
	@Override
	public com.servinglynk.hmis.warehouse.model.v2016.Exitrhy getExitrhyByDedupExitrhyId(UUID id,String projectGroupCode) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Exitrhy.class);
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<com.servinglynk.hmis.warehouse.model.v2016.Exitrhy> getAllExitrhy(Integer startIndex, Integer maxItems) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Exitrhy.class);	
		List<com.servinglynk.hmis.warehouse.model.v2016.Exitrhy> exitrhy = (List<com.servinglynk.hmis.warehouse.model.v2016.Exitrhy>) findByCriteria(criteria,startIndex,maxItems);
		return exitrhy;
	}
	...
	public long getExitrhyCount(){
	   ...
	   public List<com.servinglynk.hmis.warehouse.model.v2016.Exitrhy> getAllExitExitrhys(UUID enrollmentId,Integer startIndex, Integer maxItems){
	       DetachedCriteria criteria=DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Exitrhy.class);
	       criteria.createAlias("exitid", "exitid");
	       criteria.add(Restrictions.eq("exitid.id", enrollmentId));
	       return (List<com.servinglynk.hmis.warehouse.model.v2016.Exitrhy>) findByCriteria(criteria,startIndex,maxItems);
	   }
