...
public interface ContactDao extends ParentDao {
	...
	void hydrateLive(com.servinglynk.hmis.warehouse.model.v2016.Contact contact);

	List<com.servinglynk.hmis.warehouse.model.v2016.Contact> getAllEnrollmentContacts(UUID enrollmentId,
