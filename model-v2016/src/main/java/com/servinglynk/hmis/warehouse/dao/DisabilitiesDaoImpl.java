...
public class DisabilitiesDaoImpl extends ParentDaoImpl implements
	...
	public void hydrateStaging(ExportDomain domain , Map<String,HmisBaseModel> exportModelMap, Map<String,HmisBaseModel> relatedModelMap) throws Exception
	{
		...
		Map<String,HmisBaseModel> modelMap = getModelMap(com.servinglynk.hmis.warehouse.model.v2016.Disabilities.class, getProjectGroupCode(domain));
		if(disabilitiesList!=null && disabilitiesList.size() > 0 )
		{
			for(Disabilities disabilities : disabilitiesList)
			{
				com.servinglynk.hmis.warehouse.model.v2016.Disabilities disabilitiesModel = getModelObject(domain, disabilities, data, modelMap);
				try {
	...
	public com.servinglynk.hmis.warehouse.model.v2016.Disabilities getModelObject(ExportDomain domain, Disabilities disabilities ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2016.Disabilities modelFromDB = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			modelFromDB = (com.servinglynk.hmis.warehouse.model.v2016.Disabilities) getModel(com.servinglynk.hmis.warehouse.model.v2016.Disabilities.class, disabilities.getDisabilitiesID(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
		
		if(modelFromDB == null) {
			modelFromDB = new com.servinglynk.hmis.warehouse.model.v2016.Disabilities();
	...
	public void hydrateHBASE(SyncDomain syncDomain) {
	   ...
	   public com.servinglynk.hmis.warehouse.model.v2016.Disabilities createDisabilities(com.servinglynk.hmis.warehouse.model.v2016.Disabilities disabilities){
	       disabilities.setId(UUID.randomUUID());
	       insert(disabilities);
	       return disabilities;
	   }
	   public com.servinglynk.hmis.warehouse.model.v2016.Disabilities updateDisabilities(com.servinglynk.hmis.warehouse.model.v2016.Disabilities disabilities){
	       update(disabilities);
	       return disabilities;
	   }
	   public void deleteDisabilities(com.servinglynk.hmis.warehouse.model.v2016.Disabilities disabilities){
	       delete(disabilities);
	   }
	   public com.servinglynk.hmis.warehouse.model.v2016.Disabilities getDisabilitiesById(UUID disabilitiesId){
		      DetachedCriteria criteria=DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Disabilities.class);
		      criteria.add(Restrictions.eq("id", disabilitiesId));
		      List<com.servinglynk.hmis.warehouse.model.v2016.Disabilities> entities = (List<com.servinglynk.hmis.warehouse.model.v2016.Disabilities>) findByCriteria(criteria);
		      if(!entities.isEmpty()) return entities.get(0);
		      return null;
	   }

	   @SuppressWarnings("unchecked")
	   public List<com.servinglynk.hmis.warehouse.model.v2016.Disabilities> getAllEnrollmentDisabilitiess(UUID enrollmentId,Integer startIndex, Integer maxItems){
	       DetachedCriteria criteria=DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.Disabilities.class);
	       criteria.createAlias("enrollmentid", "enrollmentid");
	       criteria.add(Restrictions.eq("enrollmentid.id", enrollmentId));
	       return (List<com.servinglynk.hmis.warehouse.model.v2016.Disabilities>) findByCriteria(criteria,startIndex,maxItems);
	   }
