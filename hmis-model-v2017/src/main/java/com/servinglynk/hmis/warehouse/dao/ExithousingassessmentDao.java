...
public interface ExithousingassessmentDao extends ParentDao {
	...
	void hydrateLive(com.servinglynk.hmis.warehouse.model.v2017.Exithousingassessment exithousingassessment);
	
	   List<com.servinglynk.hmis.warehouse.model.v2017.Exithousingassessment> getAllExitExithousingassessments(UUID exitId,Integer startIndex, Integer maxItems);
