...
public class EnrollmentCocDaoImpl extends ParentDaoImpl implements
	...
	public void hydrateStaging(ExportDomain domain , Map<String,HmisBaseModel> exportModelMap, Map<String,HmisBaseModel> relatedModelMap) throws Exception {
		...
		Data data =new Data();
		Map<String,HmisBaseModel> modelMap = getModelMap(com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc.class, getProjectGroupCode(domain));
		...
		hydrateBulkUploadActivityStaging(data.i,data.j,data.ignore, com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc.class.getSimpleName(), domain,exportEntity);
	}

	public com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc getModelObject(ExportDomain domain, EnrollmentCoC enrollmentCoc ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc modelFromDB = null;
		// We always insert for a Full refresh and update if the record exists for Delta refresh
		if(!isFullRefresh(domain))
			modelFromDB = (com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc) getModel(com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc.class, enrollmentCoc.getEnrollmentCoCID(), getProjectGroupCode(domain),false,modelMap, domain.getUpload().getId());
		
		if(modelFromDB == null) {
			modelFromDB = new com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc();
			modelFromDB.setId(UUID.randomUUID());
			modelFromDB.setRecordToBeInserted(true);
		}
		com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc model = new com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc();
	...
	public void hydrateHBASE(SyncDomain syncDomain) {
	   ...
	   public com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc createEnrollmentCoc(com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc enrollmentCoc){
	       enrollmentCoc.setId(UUID.randomUUID()); 
	       insert(enrollmentCoc);
	       return enrollmentCoc;
	   }
	   public com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc updateEnrollmentCoc(com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc enrollmentCoc){
	       update(enrollmentCoc);
	       return enrollmentCoc;
	   }
	   public void deleteEnrollmentCoc(com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc enrollmentCoc){
	   ...
	   public List<com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc> getAllEnrollmentEnrollmentCocs(UUID enrollmentId,Integer startIndex, Integer maxItems){
	       ...
	       return (List<com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc>) findByCriteria(criteria,startIndex,maxItems);
	   }
	...
	public com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc getEnrollmentCocByDedupEnrollmentCocId(UUID id,String projectGroupCode) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc.class);
		criteria.add(Restrictions.eq("dedupClientId", id));
		List<com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc> enrollmentCoc = (List<com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc>) findByCriteria(criteria);
	...
	@Override
	public List<com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc> getAllEnrollmentCoc(Integer startIndex, Integer maxItems) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc.class);	
		List<com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc> enrollmentCoc = (List<com.servinglynk.hmis.warehouse.model.v2016.EnrollmentCoc>) findByCriteria(criteria,startIndex,maxItems);
		return enrollmentCoc;
	}
