...
public class EnrollmentCocDaoImpl extends ParentDaoImpl implements
	...
	public void hydrateStaging(ExportDomain domain , Map<String,HmisBaseModel> exportModelMap, Map<String,HmisBaseModel> relatedModelMap) throws Exception {
		...
		if(enrollmentCoCs!=null)
		{
			for(EnrollmentCoC enrollmentCoc : enrollmentCoCs)
			{
				...
				try {
					...
					enrollmentCocModel.setClientCoc(enrollmentCoc.getClientCoC());
		...
		hydrateBulkUploadActivityStaging(data.i,data.j,data.ignore, com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc.class.getSimpleName(), domain,exportEntity);
	}

	public com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc getModelObject(ExportDomain domain, EnrollmentCoC enrollmentCoc ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc modelFromDB = null;
		...
		com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc model = new com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc();
	...
	public void hydrateHBASE(SyncDomain syncDomain) {
	   ...
	   public com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc createEnrollmentCoc(com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc enrollmentCoc){
	       enrollmentCoc.setId(UUID.randomUUID()); 
	       insert(enrollmentCoc);
	       return enrollmentCoc;
	   }
	   public com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc updateEnrollmentCoc(com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc enrollmentCoc){
	       update(enrollmentCoc);
	       return enrollmentCoc;
	   }
	   public void deleteEnrollmentCoc(com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc enrollmentCoc){
	       delete(enrollmentCoc);
	   }
	   public com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc getEnrollmentCocById(UUID enrollmentCocId){ 
		      DetachedCriteria criteria=DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc.class);
		      criteria.add(Restrictions.eq("id", enrollmentCocId));
		      List<com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc> entities = (List<com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc>) findByCriteria(criteria);
		      if(!entities.isEmpty()) return entities.get(0);
		      return null;
	   }
	   public List<com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc> getAllEnrollmentEnrollmentCocs(UUID enrollmentId,Integer startIndex, Integer maxItems){
	       DetachedCriteria criteria=DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc.class);
	       criteria.createAlias("enrollmentid", "enrollmentid");
	       criteria.add(Restrictions.eq("enrollmentid.id", enrollmentId));
	       return (List<com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc>) findByCriteria(criteria,startIndex,maxItems);
	   }
	...
	public com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc getEnrollmentCocByDedupEnrollmentCocId(UUID id,String projectGroupCode) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc.class);
		criteria.add(Restrictions.eq("dedupClientId", id));
		List<com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc> enrollmentCoc = (List<com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc>) findByCriteria(criteria);
	...
	@Override
	public List<com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc> getAllEnrollmentCoc(Integer startIndex, Integer maxItems) {
		DetachedCriteria criteria = DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc.class);	
		List<com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc> enrollmentCoc = (List<com.servinglynk.hmis.warehouse.model.v2017.EnrollmentCoc>) findByCriteria(criteria,startIndex,maxItems);
		return enrollmentCoc;
	}
