...
public interface ExitrhyDao extends ParentDao {
	...
	void hydrateLive(com.servinglynk.hmis.warehouse.model.v2016.Exitrhy exitrhy);
	
	List<com.servinglynk.hmis.warehouse.model.v2016.Exitrhy> getAllExitExitrhys(UUID enrollmentId,Integer startIndex, Integer maxItems);
