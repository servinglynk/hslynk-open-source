...
public class RhybcpstatusDaoImpl extends ParentDaoImpl implements
	...
	public void hydrateStaging(ExportDomain domain , Map<String,HmisBaseModel> exportModelMap, Map<String,HmisBaseModel> relatedModelMap) throws Exception {
		...
		Data data =new Data();
		Map<String,HmisBaseModel> modelMap = getModelMap(com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus.class, getProjectGroupCode(domain));
		if(rhybcpStatusList !=null && !rhybcpStatusList.isEmpty())
		{
			...
			hydrateBulkUploadActivityStaging(data.i,data.j,data.ignore, com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus.class.getSimpleName(), domain,exportEntity);
		}

	}

	public com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus getModelObject(ExportDomain domain, RHYBCPStatus rhybcpStatus ,Data data, Map<String,HmisBaseModel> modelMap) {
		com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus modelFromDB = null;
		...
		com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus model = new com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus();
	...
	public void hydrateHBASE(SyncDomain syncDomain) {
	   ...
	   public com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus createRhybcpstatus(com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus rhybcpstatus){
	       rhybcpstatus.setId(UUID.randomUUID()); 
	       insert(rhybcpstatus);
	       return rhybcpstatus;
	   }
	   public com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus updateRhybcpstatus(com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus rhybcpstatus){
	       update(rhybcpstatus);
	       return rhybcpstatus;
	   }
	   public void deleteRhybcpstatus(com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus rhybcpstatus){
	       delete(rhybcpstatus);
	   }
	   public com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus getRhybcpstatusById(UUID rhybcpstatusId){ 
		      DetachedCriteria criteria=DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus.class);
		      criteria.add(Restrictions.eq("id", rhybcpstatusId));
		      List<com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus> entities = (List<com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus>) findByCriteria(criteria);
		      if(!entities.isEmpty()) return entities.get(0);
		      return null;
	   }
	   public List<com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus> getAllEnrollmentRhybcpstatuss(UUID enrollmentId,Integer startIndex, Integer maxItems){
	       DetachedCriteria criteria=DetachedCriteria.forClass(com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus.class);
	       criteria.createAlias("enrollmentid", "enrollmentid");
	       criteria.add(Restrictions.eq("enrollmentid.id", enrollmentId));
	       return (List<com.servinglynk.hmis.warehouse.model.v2017.RhybcpStatus>) findByCriteria(criteria,startIndex,maxItems);
	   }
