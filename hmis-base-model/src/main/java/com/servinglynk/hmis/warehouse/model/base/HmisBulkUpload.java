...
public class HmisBulkUpload extends HmisBaseModel {
	/** Serial Version UID. */
...
/**
    ...
    */
    @Override
    public HmisBulkUpload clone() throws CloneNotSupportedException {
		
        final HmisBulkUpload copy = (HmisBulkUpload)super.clone();
	...
	public boolean equals(final Object aThat) {
		...
		final HmisBulkUpload that; 
		try {
			that = (HmisBulkUpload) proxyThat;
