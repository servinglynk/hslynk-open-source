...
public class EnrollmentServiceImpl extends BaseService implements EnrollmentService {
	...
	public void createEnrollment(String schemaYear,UUID clientId,EnrollmentModel enrollmentModel,HttpHeaders headers) {
		...
		try {
			...
			ResponseEntity<EnrollmentModel> responseEntity =	restTemplate.exchange("http://internal.hslynk.com:20999/hmis-clientapi-v"+schemaYear+"/rest/clients/"+clientId+"/enrollments?updateGenericHouseHold=false", HttpMethod.POST,requestEntity, EnrollmentModel.class);
