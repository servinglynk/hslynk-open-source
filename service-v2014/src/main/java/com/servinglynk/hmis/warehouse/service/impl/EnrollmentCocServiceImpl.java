...
public class EnrollmentCocServiceImpl extends ServiceBase implements EnrollmentCocService  {
	   ...
	   public EnrollmentCoc createEnrollmentCoc(EnrollmentCoc enrollmentCoc,UUID enrollmentId,String caller){
	       com.servinglynk.hmis.warehouse.model.v2014.EnrollmentCoc pEnrollmentCoc = EnrollmentCocConverter.modelToEntity(enrollmentCoc, null);
	   ...
	   public EnrollmentCoc updateEnrollmentCoc(EnrollmentCoc enrollmentCoc,UUID enrollmentId,String caller){
	       com.servinglynk.hmis.warehouse.model.v2014.Enrollment pEnrollment = daoFactory.getEnrollmentDao().getEnrollmentById(enrollmentId); 
	       if(pEnrollment == null) throw new EnrollmentNotFound(); 
	       com.servinglynk.hmis.warehouse.model.v2014.EnrollmentCoc pEnrollmentCoc = daoFactory.getEnrollmentCocDao().getEnrollmentCocById(enrollmentCoc.getEnrollmentCocId());
	   ...
	   public EnrollmentCoc deleteEnrollmentCoc(UUID enrollmentCocId,String caller){
	       com.servinglynk.hmis.warehouse.model.v2014.EnrollmentCoc pEnrollmentCoc = daoFactory.getEnrollmentCocDao().getEnrollmentCocById(enrollmentCocId);
	       if(pEnrollmentCoc==null) throw new EnrollmentCocNotFoundException();
	   ...
	   public EnrollmentCocs getAllEnrollmentEnrollmentCocs(UUID enrollmentId,Integer startIndex, Integer maxItems){
	       EnrollmentCocs enrollmentCocs = new EnrollmentCocs();
	        List<com.servinglynk.hmis.warehouse.model.v2014.EnrollmentCoc> entities = daoFactory.getEnrollmentCocDao().getAllEnrollmentEnrollmentCocs(enrollmentId,startIndex,maxItems);
	        for(com.servinglynk.hmis.warehouse.model.v2014.EnrollmentCoc entity : entities){
